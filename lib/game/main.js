...
ig.global.encounter = {zone: 0, spawn_min: 0, spawn_max: 1};
ig.global.party = [];
            ...
            if(this.units[this.activeUnit] !== this.targetedUnit) {
                ...
                // Initiate battle animation sequence ------------------------------------------------------------
                    ...
                    this.attackQueue[0].pos = {
                        ...
                        y: this.screen.y + 300 - this.attackQueue[0].size.y
                    };

                    this.attackQueue[1].pos = {
                        x: this.screen.x + ig.system.width / 2 - this.attackQueue[1].size.x / 2,
                        y: this.screen.y + 300 - this.attackQueue[1].size.y
                    };
        ...
        update: function() {
            ...
            if(ig.input.pressed('leftClick')) {
                if(this.dialog_index < this.dialogCatalog.map1.dialog.length - 1)
                    ...
                    console.log("Moving onto battle state");
                }
            }
        },
    ...
    ig.StartScreen = ig.BaseGame.extend({
        ...
        fadeIn: function() {
            this.screenFadeIn = new ig.ScreenFader({
                fade: 'in',
                speed: 1.5,
                callback: function() { ig.system.setGame(ig.CutScenes); },
                delayBefore: 1,
                delayAfter: 1
            });
        }
