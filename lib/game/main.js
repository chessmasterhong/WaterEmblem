    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        init: function() {
            ...
            this.levelUpTimer = new ig.Timer(10);
                    ...
                    if(this.units[this.activeUnit].unitType === 'player'){
                        ...
                        if(this.levelUpMessageTimer.delta() > 0){
                            ...
                            if(this.levelUpModalTimer.delta() < 0){
                                ...
                                // Draw unit level
                                this.font30.default.draw(this.units[this.activeUnit].level - 1, 300, 160);
                        ...
                        if(this.levelUpMessageTimer.delta() > 0){
                            ...
                            if(this.levelUpModalTimer.delta() < 0){
                                ...
                                // Draw unit level
                                this.font30.default.draw(this.targetedUnit.level - 1, 300, 160);
                                this.font30.green.draw('->', 315, 165);
