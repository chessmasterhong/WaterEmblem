                                    ...
                                    ig.game.spawnEntity( Button, ig.game.screen.x + 300, ig.game.screen.y + 200, {
                                        ...
                                        pressedDown: function() {
                                            ...
                                            // into the first slot.
                                                ...
                                                // Experimental swap 
                                                var temp = ig.game.units[ig.game.activeUnit].items[1]; //item2
                                                ig.game.units[ig.game.activeUnit].items[1] = ig.game.units[ig.game.activeUnit].items[0]; //[item 1]
                                                ig.game.units[ig.game.activeUnit].items[0] = temp;
