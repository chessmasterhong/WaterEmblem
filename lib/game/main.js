                ...
                if(this.battleState === 'attack') {
                    ...
                    if(this.attackQueueIndex === 0 && this.atkAnimTimer.delta() > 1) {
                        ...
                        // Active unit is playing their attack animation and is on animation frame just before striking
                            ...
                            } else if((this.computeBattleNormalHitChance(this.units[this.activeUnit],this.targetedUnit) + this.weaponTriangle(this.units[this.activeUnit], this.targetedUnit).a) 
                                            > Math.random() * 100) {
                                console.log("Hit rate of attacking unit is: " + (this.computeBattleNormalHitChance(this.units[this.activeUnit], this.targetedUnit) + 
                    ...
                    // Counterattack -----------------------------------------------
                        ...
                        // Target unit is playing their attack animation and is on animation frame just before striking
                            ...
                            } else if( ( this.computeBattleNormalHitChance(this.targetedUnit, this.units[this.activeUnit]) + this.weaponTriangle(this.targetedUnit, this.units[this.activeUnit]).a )
                                            > Math.random() * 100) {
                                this.screenshakeIntensity = 5;
                                console.log("Attack rate of counter-attacking unit is : " + (this.computeBattleNormalHitChance(this.targetedUnit, this.units[this.activeUnit]) 
                                                                                                + this.weaponTriangle(this.targetedUnit, this.units[this.activeUnit]).a ) );
