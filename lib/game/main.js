        ...
        update: function() {
            ...
            if(this.units[this.activeUnit].turnUsed) {
                ...
                for(var u = 0; u < this.units.length; u++) {
                    ...
                    } else if(this.units[u] instanceof EntityHero && !this.units[u]._killed)
            ...
            // Check end battle condition
            this.scriptCatalog.map0.objective.condition(unitFocus, enemy_count);

            // End battle
            if(!this.end_battle && this.scriptCatalog.map0.objective.triggered) {
