...
.defines(function() {
    ...
    ig.BaseGame = ig.Game.extend({
        font30: {
            default: new ig.Font('media/04b03_30.font.png', { fontColor: '#ECEEA1', borderColor: '#404040' }),
    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        init: function() {
            ...
            // This timer controls the entire level up state
            this.levelUpTimer = new ig.Timer(7);
            // How long to display "Level up!"
            this.levelUpMessageTimer = new ig.Timer(1.5);
            // How long to display level up modal
            this.levelUpModalTimer = new ig.Timer(1.5);
            // How long between displaying each +1 bonus
            this.levelUpBonusTimer = new ig.Timer(1.0);
            ...
            if(ig.global.gameState !== 'continue') {
                ...
                var party_temp = [];
                var party_temp_pos = [];
                var party_members_pool = [ig.global.EntityFemale_sage, ig.global.EntityFemale_sage];
                    ...
                    // Post-battle computations --------------------------------
                        ...
                        // Enemy unit is the attacking unit
                            ...
                            if(this.targetedUnit.unitType === 'player') {
                                ...
                                if(this.battleAnimStats.activeUnit.health <= 0) {
                                    this.targetedUnit.exp_curr += this.computeExperience(this.targetedUnit, this.units[this.activeUnit], true);
                                    console.log(this.targetedUnit.name + ' gained ' + this.computeExperience(this.targetedUnit, this.units[this.activeUnit], true) + ' exp and now has ' + this.units[this.activeUnit].exp_curr + ' exp for current level ' + this.units[this.activeUnit].level + '.');
            ...
            this.screenFadeOutAfterEffect = new ig.ScreenFader({
                ...
                callback: function() {
                    ...
                    if(
                        ...
                        (typeof this.targetedUnit !== 'undefined' && this.targetedUnit.unitType === 'player' && this.targetedUnit.leveledUp === true)
                    ){
    ...
    */
    ...
    ig.GameCredits = ig.BaseGame.extend({
        ...
        init: function(x, y, settings) {
            ...
            this.credits_roll = this.spawnEntity( ig.global.EntityCredits_roll, 0, ig.system.height + 50, {
                vel: { x: 0, y: -25 }
            });
        },
