    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        applyWeapon: function(base_atk, base_wt, base_crit, base_hit){
            /*
                Paramters:
                    - base_atk: input atk fed in from equipWeapon
                    - base_wt: input wt fed in from equipWeapon
                    - base_crit: input crit fed in from equipWeapon
                    - base_hit: input hit fed in from equipWeapon
            */
        ...
        draw: function() {
            if(!this.screenshaker)
                ...
                ig.system.context.save();
                    ...
                    //   y: min = 10 * (0 + 1) = 10 px
                    //      max = 10 * (1 + 1) = 20 px
                    ig.system.context.translate(10 * (Math.random() + 1), 10 * (Math.random() + 1));
                    this.parent();
