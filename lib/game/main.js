            ...
            if(ig.input.state('items') && this.units[this.activeUnit].unitType === 'player' && !this.menuVisible) {
                ...
                ig.game.spawnEntity(Button, ig.game.screen.x + 75, ig.game.screen.y + 65, {
                    ...
                    pressedDown: function() {
                        ...
                        // Check if first child buttons exist (minimum check child button #1). If not spawn them, else do nothing.
                        if(typeof ig.game.getEntityByName('btn_item_1') === 'undefined') {
                                        ...
                                        ig.game.spawnEntity(Button, ig.game.screen.x + 300, ig.game.screen.y + 200, {
                                            ...
                                            pressedDown: function() {
                                                ...
                                                if(ig.game.selectedItem == ig.game.units[ig.game.activeUnit].items[0]) {
                                                    ...
                                                    var buttons = ig.game.getEntityByName('1btn_items');
                                                    var buttons2 = ig.game.getEntityByName('2btn_items');
                                                    buttons.kill();
                                                    buttons2.kill();
                                                    this.kill();
                                                } else {
                                                    ...
                                                    var buttons = ig.game.getEntityByName('2btn_items');
                                                    var buttons2 = ig.game.getEntityByName('1btn_items');
                                                    buttons.kill();
                                                    buttons2.kill();
                                                    // Redraw the items
                                                    this.kill();
