...
.defines(function() {
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        terrain: {
            0: {type: 'Plain',    move: 1, def: 0, avoid: 0             },
            1: {type: 'Fortress', move: 1, def: 2, avoid: 20, hp_rec: 10},
            2: {type: 'Forest',   move: 2, def: 1, avoid: 20            },
            3: {type: 'Mountain', move: 3, def: 1, avoid: 40            },
            4: {type: 'Sand',     move: 2, def: 0, avoid: 10            },

            // Testing purposes only
            29: {type: 'Plain',    move: 1, def: 0, avoid: 0            },
        },
        ...
        draw: function() {
            ...
            if(ig.input.state('menu')){
                this.statScreen.draw(x, y);
                this.font.draw('Name: ' + ig.game.units[ig.game.activeUnit].name, x + 90, y + 20, ig.Font.ALIGN.CENTER);
                this.font.draw('ATK:' +  ig.game.units[ig.game.activeUnit].stat.atk, x + 90, y + 40, ig.Font.ALIGN.CENTER);
                this.font.draw('MAG:' +  ig.game.units[ig.game.activeUnit].stat.mag, x + 90, y + 60, ig.Font.ALIGN.CENTER);
                this.font.draw('DEF:' +  ig.game.units[ig.game.activeUnit].stat.def, x + 90, y + 80, ig.Font.ALIGN.CENTER);
                this.font.draw('RES:' +  ig.game.units[ig.game.activeUnit].stat.res, x + 90, y + 100, ig.Font.ALIGN.CENTER);
                this.font.draw('SPD:' +  ig.game.units[ig.game.activeUnit].stat.spd, x + 90, y + 120, ig.Font.ALIGN.CENTER);
                this.font.draw('LUK:' +  ig.game.units[ig.game.activeUnit].stat.luk, x + 90, y + 140, ig.Font.ALIGN.CENTER);
