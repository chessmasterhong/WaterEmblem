...
.requires(
    ...
    // Menu buttons
    'game.entities.menus.button_startscreen_start',
    ...
    */
    ...
    ig.StartScreen = ig.BaseGame.extend({
        ...
        init: function(x, y, settings) {
            ...
            this.spawnEntity(EntityButton_startscreen_start, ig.system.width / 2 - 100, 280);
            this.spawnEntity(EntityButton_startscreen_settings, ig.system.width / 2 - 100, 320);
