    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        update: function() {
            ...
            if(ig.input.pressed('escape') || this.units[this.activeUnit].unitType !== 'player') {
                if(this.clickedUnit !== null && this.units[this.activeUnit].unitType === 'player') {
                    if(this.units[this.activeUnit].pos !== this.units[this.activeUnit].init_pos) {
                        // User wants to undo/cancel the unit movement
                        this.units[this.activeUnit].pos = this.units[this.activeUnit].init_pos;
                        this.units[this.activeUnit].mov_curr = this.units[this.activeUnit].stat.mov;
