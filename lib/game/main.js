                    ...
                    if(this.units[this.activeUnit].unitType === 'player') {
                        ...
                        ig.system.context.beginPath();
                            ig.system.context.rect(
                                ...
                                269 * (((this.exp_old + this.exp_gain) / this.units[this.activeUnit].exp_levelUp) % this.units[this.activeUnit].exp_levelUp) * ((this.exp_time + (this.expTimer.delta() < 0 ? this.expTimer.delta() : 0)) / this.exp_time),
                                10
                            );
