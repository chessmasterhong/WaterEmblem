...
.defines(function() {
    ...
    ig.BaseGame = ig.Game.extend({
        font20_default: new ig.Font('media/04b03_20.font.png', { fontColor: '#ECEEA1', borderColor: '#00000' }),
        font16_default: new ig.Font('media/04b03_16.font.png', { fontColor: '#ECEEA1', borderColor: '#00000' }),
        font12_default: new ig.Font('media/04b03_12.font.png', { fontColor: '#ECEEA1', borderColor: '#00000' }),
        font20_green:   new ig.Font('media/04b03_20.font.png', { fontColor: '#3CDC3C', borderColor: '#00000' }),
        font16_green:   new ig.Font('media/04b03_16.font.png', { fontColor: '#3CDC3C', borderColor: '#00000' }),
        font12_green:   new ig.Font('media/04b03_12.font.png', { fontColor: '#3CDC3C', borderColor: '#00000' }),
        font20_red:     new ig.Font('media/04b03_20.font.png', { fontColor: '#FF6400', borderColor: '#00000' }),
        font16_red:     new ig.Font('media/04b03_16.font.png', { fontColor: '#FF6400', borderColor: '#00000' }),
        font12_red:     new ig.Font('media/04b03_12.font.png', { fontColor: '#FF6400', borderColor: '#00000' }),
    ...
    ig.BattleMode = ig.BaseGame.extend({
                ...
                if(this.battleState === 'attack') {
                    ...
                    // Counterattack -----------------------------------------------
                        ...
                        if(this.attackQueue.length === 2 || this.units[this.activeUnit]._killed || this.targetedUnit._killed || (this.attackQueue[2].currentAnim === this.attackQueue[2].anims.attack1 && this.attackQueue[2].currentAnim.loopCount >= 1)) {
                            ...
                            this.battleAnimControllers.effects.currentAnim = this.battleAnimControllers.gui.anims.none;
                            this.battleAnimControllers.background.currentAnim = this.battleAnimControllers.gui.anims.none;
        ...
        draw: function() {
            ...
            if(this.units[this.activeUnit].unitType === 'player' && this.battleState !== 'battle_start' && this.hoveredUnit !== null) {
                ...
                this.font16_black.draw('HP: ' + this.hoveredUnit.health + '/' + this.hoveredUnit.health_max, 85, 435);
            ...
            if(this.units[this.activeUnit].unitType === 'player' && this.battleState !== 'battle_start' && this.clickedUnit === null && this.hoveredTerrain !== null) {
                this.terrainModal.draw(470, 390);
                this.font16_black.draw(this.hoveredTerrain.type,  505, 416);
                this.font12_black.draw(this.hoveredTerrain.def,   560, 437);
                this.font12_black.draw(this.hoveredTerrain.avoid, 560, 449);
            }
                ...
                if(this.hoveredUnit !== null && this.attackTargets.length > 0) {
                    for(var i = 0; i < this.attackTargets.length; i++) {
                        if(this.hoveredUnit === this.attackTargets[i]) {
                            ...
                            if(this.units[this.activeUnit].item[0] !== null) this.units[this.activeUnit].item[0].icon.draw(            525,   5                      );
                            this.font16_default.draw(this.units[this.activeUnit].name,                                                 592,  15, ig.Font.ALIGN.CENTER);
                            this.font16_default.draw(this.units[this.activeUnit].health,                                               605,  47                      );
                            this.font16_default.draw(this.computeBattleNormalDamage(this.units[this.activeUnit], this.hoveredUnit),    605,  80                      );
                            this.font16_default.draw(this.computeBattleNormalHitChance(this.units[this.activeUnit], this.hoveredUnit), 605, 113                      );
                            this.font16_default.draw(this.computeBattleCritChance(this.hoveredUnit, this.units[this.activeUnit]),      605, 144                      );

                            this.font16_default.draw(this.hoveredUnit.health,                                                          554,  47, ig.Font.ALIGN.RIGHT );
                            this.font16_default.draw(this.computeBattleNormalDamage(this.hoveredUnit, this.units[this.activeUnit]),    554,  80, ig.Font.ALIGN.RIGHT );
                            this.font16_default.draw(this.computeBattleNormalHitChance(this.hoveredUnit, this.units[this.activeUnit]), 554, 113, ig.Font.ALIGN.RIGHT );
                            this.font16_default.draw(this.computeBattleCritChance(this.units[this.activeUnit], this.hoveredUnit),      554, 144, ig.Font.ALIGN.RIGHT );
                            this.font16_default.draw(this.hoveredUnit.name,                                                            563, 178, ig.Font.ALIGN.CENTER);
                            if(this.hoveredUnit.item[0] !== null) {
                                this.hoveredUnit.item[0].icon.draw(                                                                    603, 168                      );
                                this.font16_default.draw(this.hoveredUnit.item[0].name,                                                563, 208, ig.Font.ALIGN.CENTER);
                            }
            ...
            if((this.battleState === 'battle_prepare' || this.battleState === 'battle_start') && this.units[this.activeUnit] !== this.targetedUnit) {
                ...
                if(this.battleState === 'battle_prepare') {
                    ...
                    //this.spawnEntity(EntityBattle_anim_terrains, ig.game.screen.x, ig.game.screen.y);
