    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        update: function() {
                    ...
                    if(this.units[this.activeUnit].unitType === 'player' && this.targetedUnit.unitType === 'player') {
                        ...
                        for(var t = 0; t < this.assistTargets.length; t++) {    
                            if(this.targetedUnit === this.assistTargets[t]) {
                            	...
                            	if(this.targetedUnit.health < this.targetedUnit.health_max) {
            ...
            if(this.battleState === 'shopping' || this.battleState === 'buying'){
                    //console.log(this.itemCatalog.shop1[0]);
                    if(typeof this.getEntityByName('btn_exit') === 'undefined'){
                        this.spawnEntity(EntityButton_shop_exit, ig.game.screen.x + 296, ig.game.screen.y + 132);
                        this.spawnEntity(EntityButton_buy, ig.game.screen.x + 164, ig.game.screen.y + 132);
                    }
            ...
            if(!this.scriptCatalog.map0.objective.triggered) {
                ...
                this.scriptCatalog.map0.objective.condition(unitFocus);
            // End battle
            } else {
