    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        applyWeapon: function(base_atk, base_wt, base_crit, base_hit){
            ...
            */
            ig.game.units[ig.game.activeUnit].mod.atk += base_atk;
            ig.game.units[ig.game.activeUnit].mod.hit += base_hit;
            ig.game.units[ig.game.activeUnit].mod.wt  += base_wt;
            ig.game.units[ig.game.activeUnit].mod.crit += base_crit;
            return ig.game.units[ig.game.activeUnit].mod;
