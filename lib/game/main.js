    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        draw: function() {
            ...
            if(this.units[this.activeUnit].unitType === 'player' && this.battleState !== 'battle_start' && this.hoveredUnit !== null) {
                ...
                this.font16_black.draw('HP: ' + this.hoveredUnit.health + '/' + this.hoveredUnit.health_max, 70, 440);
            ...
            if(this.units[this.activeUnit].unitType === 'player' && this.battleState !== 'battle_start' && this.clickedUnit === null && this.hoveredTerrain !== null) {
                ...
                this.font16_black.draw(this.hoveredTerrain.type,  515, 426);
                this.font12_black.draw(this.hoveredTerrain.def,   570, 447);
                this.font12_black.draw(this.hoveredTerrain.avoid, 570, 459);
            }
