...
.defines(function() {
    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        applyWeapon: function(mod_atk, mod_wt, mod_crit, mod_hit){
            ig.game.units[ig.game.activeUnit].stat.atk += mod_atk;
            ig.game.units[ig.game.activeUnit].stat.hit += mod_hit;
            ig.game.units[ig.game.activeUnit].stat.wt  += mod_wt;
            ig.game.units[ig.game.activeUnit].stat.crit += mod_crit;
