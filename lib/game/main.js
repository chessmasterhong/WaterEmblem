    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        init: function() {
            ...
            //ig.music.add('media/sounds/bgm/czhang/companions.ogg');
            //ig.music.loop = true;
            //ig.music.volume = 0.5;
            //ig.music.play();
    ...
    /*ig.StartScreen = ig.BaseGame.extend({
        screenBackground: new ig.Image('media/start_screen.png'),
        ...
        draw: function() {
            ...
            this.font16_default.draw('Left click to start', ig.system.width / 2, 440, ig.Font.ALIGN.CENTER);
