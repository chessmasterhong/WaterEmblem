    ...
    **/
    BattleMode = BaseGame.extend({
        ...
        init: function() {
            ...
            enemy = enemy_spawner.spawnEnemies(enemy_spawner.generateEnemies(num_of_enemies));
            //console.log(enemy);
        ...
        update: function() {
            ...
            if((player.pos.x === tilesize || player.pos.x === mapsize.x - tilesize * 2 ||
                player.pos.y === tilesize || player.pos.y === mapsize.y - tilesize * 2 ||
