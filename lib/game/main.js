    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        recomputeStats: function(entity, clear) {
            ...
            // Equipped item
            else if(entity.item[0] !== null && entity.item[0].type === 'equip' && this.isValidWeapon(entity.item[0].affinity, entity) && !clear) {
                console.log("Still equipping weapon");
            ...
            console.log("Do we have an equipped weapon: " + entity.hasEquippedItem);
            ...
            if(this.battleState === 'stats') {
                    ...
                    // because the `i` never gets incremented.
                        ...
                        for(var i = 0; i < a.item.length; i++) {
                            if(a.item[i] !== null && a.item[i] !== 'undefined') {
                                a.item[i].icon.draw(380, 250 + i * 40);
