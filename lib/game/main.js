...
.defines(function() {
    ...
    ig.BaseGame = ig.Game.extend({
        ...
        init: function() {
            ...
            ig.input.bind(ig.KEY.MOUSE2,      'click'    ); // Right Mouse Button: interacts with "menus" currently.
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        draw: function() {
            ...
            // Menu to prematurely end player unit's turn
    ...
    ig.main('#canvas', ig.GameOver, 60, 640, 480, 1);
}); // End .defines
