    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
            ...
            if(this.battleAnimStage === 'attack' && this.units[this.activeUnit] !== this.targetedUnit) {
                ...
                if(this.attackQueueIndex === 0 && this.atkAnimTimer.delta() > 1) {
                    ...
                    // Active unit is playing their attack animation and is on animation frame just before striking
                        ...
                        this.targetedUnit.receiveDamage(this.units[this.activeUnit].derived_stats.atk - this.targetedUnit.stat.def, this.units[this.activeUnit]); // Inflict damage
                ...
                // Counterattack -----------------------------------------------
                    ...
                    // Target unit is playing their attack animation and is on animation frame just before striking
                        ...
                        this.screenshaker = true;
                        this.units[this.activeUnit].receiveDamage(this.targetedUnit.derived_stats.atk - this.units[this.activeUnit].stat.def, this.targetedUnit); // Inflict damage
        ...
        recomputeStats: function(entity){
            ...
            else // Attack speed = base spd - (weapon weight - player base wt stat)
