                ...
                if(units_moved === this.units.length) {
                    for(var u = 0; u < this.units.length; u++) {
                        if(!this.units[u]._killed) {
                            ...
                            this.units[u].currentAnim = this.units[u].anims.idle;
                        }
                    }
                }
                ...
                if(this.battleState === 'shopping' || this.battleState === 'buying' || this.battleState === 'selling') {
                    if(this.battleState === 'shopping') {
                        ...
                        if(typeof this.getEntityByName('btn_shop_exit') === 'undefined') {
                            this.spawnEntity(EntityButton_shop_exit, ig.game.screen.x + 264, ig.game.screen.y + 132);
                            this.spawnEntity(EntityButton_shop_buy, ig.game.screen.x + 164, ig.game.screen.y + 132);
                            this.spawnEntity(EntityButton_shop_sell, ig.game.screen.x + 428, ig.game.screen.y + 132);
                        }
                    }
                    ...
                    if(this.battleState === 'selling'){
                        ...
                        if(ig.game.units[ig.game.activeUnit].selectedItemIndex !== null){
                            if(ig.game.units[ig.game.activeUnit].item[ig.game.units[ig.game.activeUnit].selectedItemIndex] !== null){
                                ...
                                console.log(ig.game.units[ig.game.activeUnit].gold);
                                // Increase Player's Gold by item amount
                                ig.game.units[ig.game.activeUnit].gold += ig.game.units[ig.game.activeUnit].item[ig.game.units[ig.game.activeUnit].selectedItemIndex].cost;
                        ...
                        else{ console.log("Item Selected is null") };
                    ...
                    if(this.battleState === 'buying') {
                        ...
                        if(this.selectedShopItemIndex !== null) {
                            var slot = this.getFreeSlot(this.units[this.activeUnit]);
                            if(slot !== null) {
                                if(this.units[this.activeUnit].gold >= this.itemCatalog.shop1[this.selectedShopItemIndex].cost){
                                    this.units[this.activeUnit].gold -= this.itemCatalog.shop1[this.selectedShopItemIndex].cost;
