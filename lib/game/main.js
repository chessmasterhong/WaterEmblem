        ...
        fadeOutAfterEffect: function() {
            this.screenFadeOutAfterEffect = new ig.ScreenFader({
                ...
                callback: function() {
                    ...
                    if(this.screenFadeInFromBattleAnim === null && (this.units[this.activeUnit].unitType === 'player' || this.targetedUnit && this.targetedUnit.unitType === 'player')) {
                        this.expTimer.reset();
                    ...
                    if(this.units[this.activeUnit].unitType === 'player') {
                        ...
                        ig.system.context.beginPath();
                            ig.system.context.rect(
                                ...
                                269 * ((this.exp_old + this.exp_gain) / this.units[this.activeUnit].exp_levelUp),
                                10
                            );
                        ig.system.context.closePath();
                        ig.system.context.fill();

                        this.font20.default.draw(this.exp_old + this.exp_gain, ig.system.width / 2 + 140, ig.system.height / 2 - 9);
                    } else if(this.targetedUnit.unitType === 'player') {
