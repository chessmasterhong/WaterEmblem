    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        draw: function() {
            ...
            if(ig.input.state('menu') && this.units[this.activeUnit].unitType === 'player' && this.battleState !== 'battle_start') {
                ...
                this.font20_default.draw(a.name,       115, 258, ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.level,      80,  377, ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.health,     80,  430, ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.health_max, 130, 430, ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.stat.str,   350, 91,  ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.stat.mag,   350, 141, ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.stat.def,   350, 186, ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.stat.res,   350, 231, ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.stat.spd,   350, 281, ig.Font.ALIGN.LEFT);
                this.font20_default.draw(a.stat.luk,   350, 331, ig.Font.ALIGN.LEFT);
            }
            ...
            if(this.units[this.activeUnit].selectedWeapon !== null && this.units[this.activeUnit].isEquipping) {
                ...
                this.font12_default.draw(a.derived_stats.atk + '->' + atkChange, 455, 405);
                this.font12_default.draw(a.derived_stats.hit_rate + '->' + hitChange, 440, 440);
                this.font12_default.draw(a.derived_stats.crit_rate + '->' + critChange, 570, 405);
                this.font12_default.draw(evadeChange, 590, 440);
                ...
                if(this.hoveredUnit !== null && this.attackTargets.length > 0) {
                    for(var i = 0; i < this.attackTargets.length; i++) {
                        if(this.hoveredUnit === this.attackTargets[i]) {
                            ...
                            this.font16_default.draw(this.units[this.activeUnit].name, 565, 10);
                            this.font16_default.draw(this.units[this.activeUnit].health, 605, 45);
                            this.font16_default.draw(this.hoveredUnit.health, 553, 45, ig.Font.ALIGN.RIGHT);
                            this.font16_default.draw(this.computeBattleNormalDamage(this.units[this.activeUnit], this.hoveredUnit), 605, 80);
                            this.font16_default.draw(this.computeBattleNormalDamage(this.hoveredUnit, this.units[this.activeUnit]), 553, 80, ig.Font.ALIGN.RIGHT);
                            this.font16_default.draw(this.computeBattleNormalHitChance(this.units[this.activeUnit], this.hoveredUnit), 605, 115);
                            this.font16_default.draw(this.computeBattleNormalHitChance(this.hoveredUnit, this.units[this.activeUnit]), 553, 115, ig.Font.ALIGN.RIGHT);
                            this.font16_default.draw(this.computeBattleCritChance(this.units[this.activeUnit], this.hoveredUnit), 553, 150, ig.Font.ALIGN.RIGHT);
                            this.font16_default.draw(this.hoveredUnit.name, 595, 180, ig.Font.ALIGN.RIGHT);
                            this.font16_default.draw(this.computeBattleCritChance(this.hoveredUnit, this.units[this.activeUnit]), 605, 145);
                            break;
                        }
                    }
                }
