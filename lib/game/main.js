    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        computeHitRate: function(weapon_accuracy, skill, luck){
            ...
            ig.game.units[ig.game.activeUnit].mod.hit += weapon_accuracy;
            // Accumulate the unit's skill stat / 2
            ig.game.units[ig.game.activeUnit].mod.hit += skill/2;
            // Accumulate the unit's luck stat /2
            ig.game.units[ig.game.activeUnit].mod.hit += luck/2;
            return ig.game.units[ig.game.activeUnit].mod.hit;
        },
