...
.defines(function() {
    ...
    ig.GameOver = ig.Game.extend({
        gameTextTitle: new ig.Font('media/arial.font_32.png'),
        gameText: new ig.Font('media/arial.font_14.png'),
 ...
 *     tilesize: The tile size of the grid to align the coordinates to.
 *
 * Postcondition:
 ...
 *     nearest multiple of the tilesize.
 */
ig.global.alignToGrid = function(pos_x, pos_y, tilesize) {
    var t = tilesize * 0.5;
    return {x: pos_x + t - (pos_x + t) % tilesize, y: pos_y + t - (pos_y + t) % tilesize};
};
