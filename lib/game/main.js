...
.defines(function() {
    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        weaponTriangle: function(entity_a, entity_b){
            // entity_a: The attacking entity
            // entity_b: The defending entity

            // Make sure both units first item is not null
            if(entity_a.item[0] != null && entity_b.item[0] != null)
                if(entity_a.item[0].affinity === 'sword' && entity_b.item[0].affinity === 'axe'){
                    entity_a.mod.hit += 15;
                    entity_b.mod.hit -= 15;
                }
                else if(entity_a.item[0].affinity === 'sword' && entity_b.item[0].affinity === 'lance'){
                    entity_a.mod.hit -= 15;
                    entity_b.mod.hit += 15;
                }
                else if(entity_a.item[0].affinity === 'axe' && entity_b.item[0].affinity === 'lance'){
                    entity_a.mod.hit += 15;
                    entity_b.mod_hit -= 15;
                }
                else if(entity_a.item[0].affinity === 'axe' && entity_b.item[0].affinity === 'sword'){
                    entity_a.mod.hit -= 15;
                    entity_b.mod.hit += 15;
                }
                else if(entity_a.item[0].affinity === 'lance' && entity_b.item[0].affinity === 'sword'){
                    entity_a.mod.hit += 15;
                    entity_b.mod.hit -= 15;
                }
                else if(entity_a.item[0].affinity === 'lance' && entity_b.item[0].affinity === 'axe'){
                    entity_a.mod.hit -= 15;
                    entity_b.mod.hit += 15;
                }
                else
                    console.log("Weapon triangle not applied");
        },
