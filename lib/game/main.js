...
.defines(function() {
    ...
    */
    ig.CutScenes = ig.BaseGame.extend({
        ...
        init: function(x, y, settings){
            this.parent(x, y, settings);
            this.modals = this.spawnEntity(EntityOverlay_dialog, 0, 0);
            console.log("Inside of cutscenes state");
            console.log(this.dialogCatalog.map0.speaker1);
        },
        ...
        draw: function(){
            this.parent();
            this.townBackground.draw(0, 0);
            this.dialogBox.draw(0, 360);
            this.modals.NinoMugshot.draw(400, 160);
            this.modals.LimstellaMugshot.draw(40,160);
        }
    });
