...
.defines(function() {
    ...
    ig.MainGame = ig.BaseGame.extend({
        ...
        draw: function() {
            ...
            if(this.showingMenu)
            {
                this.baseMenu.draw(0,0);
                var x = this.baseMenu.width/2;
                var y = this.baseMenu.height/2;
                this.font.draw('Item', x, y - 40, ig.Font.ALIGN.CENTER);
                this.font.draw('Unit', x, y - 20, ig.Font.ALIGN.CENTER);
                this.font.draw('End Turn', x, y, ig.Font.ALIGN.CENTER);
            }
