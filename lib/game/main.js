...
.defines(function() {
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        draw: function() {
            ...
            if(ig.input.state('items') && this.units[this.activeUnit].unitType === 'player') {
                this.showingMenu = true;
                ig.game.spawnEntity(Button, ig.game.screen.x + 75, ig.game.screen.y + 65, {
                    name: 'btn_wait',
                    font: new ig.Font('media/arial.font_14.png'),
                    ...
                    pressedDown: function() {
                        ...
                        // First Item
                        ig.game.spawnEntity( Button, ig.game.screen.x + 100, ig.game.screen.y + 65, {
                            font: new ig.Font('media/arial.font_14.png'),
                            text: ['1'],
                            textPos: { x: 37, y: 8 },
                            textAlign: ig.Font.ALIGN.CENTER,
                        ...
                        // Second Item
                        ig.game.spawnEntity( Button, ig.game.screen.x + 100, ig.game.screen.y + 90, {
                            font: new ig.Font('media/arial.font_14.png'),
                            text: ['2'],
                            textPos: { x: 37, y: 8 },
                            textAlign: ig.Font.ALIGN.CENTER,
