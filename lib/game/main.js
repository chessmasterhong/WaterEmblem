                ...
                if(this.battleState === 'attack') {
                    ...
                    if(this.attackQueueIndex === 0 && this.atkAnimTimer.delta() > 1) {
                        ...
                        // Active unit is playing their attack animation and is on animation frame just before striking
                            ...
                            } else if(((this.computeBattleNormalHitChance(this.units[this.activeUnit], this.targetedUnit)) + weaponBonuses.a) > Math.random() * 100) {
                                console.log("Enemy evade rate is : " + this.targetedUnit.derived_stats.evade);
                                console.log("Hit rate: " + (this.computeBattleNormalHitChance(this.units[this.activeUnit], this.targetedUnit) + weaponBonuses.a));
                    ...
                    // Counterattack -----------------------------------------------
                        ...
                        // Target unit is playing their attack animation and is on animation frame just before striking
                            ...
                            } else if((this.computeBattleNormalHitChance(this.targetedUnit, this.units[this.activeUnit]) + weaponBonuses.b) > Math.random() * 100) {
                                console.log("Enemy evade rate is: " + this.targetedUnit.derived_stats.evade);
                                this.screenshakeIntensity = 5;
