...
.defines(function() {
    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        // Declare temp. variable for enemy-dropped items
        item_drop: null,
        item_drop_uses: null,
        ...
        draw: function() {
            ...
            else if (this.item_drop !== null && this.units[this.activeUnit] !== 'player') {
                if (this.targetedUnit.selectedWeapon !== null && this.targetedUnit.isEquipping) {
                    this.weaponModal.draw(390, 350);
                    var a = this.targetedUnit;
                    a.statMugshot.draw(410, 150);
