                ...
                // Initiate battle animation sequence ------------------------------------------------------------
                    ...
                    // Counterattack -------------------------------------------
                        ...
                        // Target unit has finished playing their attack animation
                            ...
                            if(!this.units[this.activeUnit]._killed && !this.targetedUnit._killed && this.attackQueue.length >= 3) {
                    ...
                    // Post-battle computations --------------------------------
                        ...
                        if(this.units[this.activeUnit].unitType === 'player' && this.targetedUnit.unitType === 'enemy' && this.targetedUnit._killed) {
                        ...
                        } else if(this.units[this.activeUnit].unitType === 'enemy' && this.targetedUnit.unitType === 'player' && this.units[this.activeUnit]._killed) {
