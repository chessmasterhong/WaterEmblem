    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        update: function() {
            ...
            if(this.battleState === 'exp' && this.expTimer.delta() > 0 &&
                (
                    ...
                    if(this.units[this.activeUnit].unitType === 'player') {
                        ...
                        ig.system.context.beginPath();
                            ig.system.context.rect(
                                ...
                                269 * (((this.exp_old + this.exp_gain * ((this.exp_time + (this.expTimer.delta() < 0 ? this.expTimer.delta() : 0)) / this.exp_time)) % this.units[this.activeUnit].exp_levelUp) / this.units[this.activeUnit].exp_levelUp),
                                10
                            );
                        ig.system.context.closePath();
                        ig.system.context.fill();

                        this.font20.default.draw((this.exp_old + this.exp_gain) % this.units[this.activeUnit].exp_levelUp, ig.system.width / 2 + 140, ig.system.height / 2 - 9);
                    } else if(this.targetedUnit.unitType === 'player') {
