...
.defines(function() {
    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        //partyMembers: 6, // Members in player's party (not including main player)
        ...
        init: function() {
            ...
            for(var p = 1; p <= party_members_pool.length; p++) {
                ig.global.party[p] = this.spawnEntity(
                    ...
                    Math.floor(this.mapsize.y / (party_members_pool.length + 1) * p / ig.global.tilesize) * ig.global.tilesize
                );
            }
