...
ig.global.encounter = {zone: 0, spawn_min: 1, spawn_max: 2};
ig.global.party = [];
    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        init: function() {
            ...
            if(ig.global.gameState !== 'continue') {
                ...
                this.activeUnit = parseInt(this.storage.get('activeUnit'));
                    ...
                    if(this.attackQueueIndex === 0 && this.atkAnimTimer.delta() > 1) {
                        ...
                        // Active unit is on the attack (normal or critical) frame where it is about to strike target unit
                            ...
                            if(this.attackQueue[0].currentAnim === this.attackQueue[0].anims.crit0) {
                                ...
                                this.displayBattleScreenEffect(this.battleAnimStats.activeUnit);
                    ...
                    // Counterattack -------------------------------------------
                        ...
                        // Target unit is on the attack (normal or critical) frame where it is about to strike active unit
                            ...
                            if(this.attackQueue[1].currentAnim === this.attackQueue[1].anims.crit0) {
                                ...
                                // Battle animation screen effects
                                this.displayBattleScreenEffect(this.battleAnimStats.targetedUnit);
    ...
    ig.StartScreen = ig.BaseGame.extend({
        ...
        init: function(x, y, settings) {
            ...
            // Sapwn start menu buttons
            this.spawnEntity(EntityButton_startscreen_newgame, 480, 280);
            this.spawnEntity(EntityButton_startscreen_continue, 480, 320); // TODO
            this.spawnEntity(EntityButton_startscreen_settings, 480, 360);
            this.spawnEntity(EntityButton_startscreen_credits, 480, 400); // TODO
