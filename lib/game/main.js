                ...
                if(this.battleAnimStage === 'attack') {
                    ...
                    if(this.attackQueueIndex === 0 && this.atkAnimTimer.delta() > 1) {
                        ...
                        // Active unit is playing their attack animation and is on animation frame just before striking
                            ...
                            if(this.units[this.activeUnit].derived_stats.crit_rate - this.targetedUnit.stat.luk > Math.random()) {
                    ...
                    // Counterattack -----------------------------------------------
                        ...
                        // Target unit is playing their attack animation and is on animation frame just before striking
                            ...
                            if(this.targetedUnit.derived_stats.crit_rate - this.units[this.activeUnit].stat.luk > Math.random()) {
                        ...
                        if(this.attackQueue.length === 2 || this.units[this.activeUnit].health <= 0 || this.targetedUnit.health <= 0 || (this.attackQueue[2].currentAnim === this.attackQueue[2].anims.attack1 && this.attackQueue[2].currentAnim.loopCount >= 1)) {
