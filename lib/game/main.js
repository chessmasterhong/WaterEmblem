...
.requires(
    ...
    'game.entities.animations.hero_battle', // Main character
    ...
    'plugins.multi-color-font.multi-color-font', // Font coloring
...
.defines(function() {
    ...
    ig.BaseGame = ig.Game.extend({
        font: new ig.Font('media/arial.font_14.png', ['FFFFFF', 'FF0000', '00FF00', '0000FF', '000000']),
    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        mode: null, // null: default
                    // 'attack0': selecting enemy unit to attack
                    // 'attack1': selecting weapon to attack enemy with
                    // 'battle': in battle animation
        ...
        update: function() {
            ...
            if(this.mode === 'attack0' && this.units[this.activeUnit] !== this.targetedUnit && this.targetedUnit.unitType === 'enemy') {
        ...
        draw: function() {
            ...
            if(this.units[this.activeUnit].unitType === 'player' && this.hoveredUnit !== null) {
                ...
                this.font.draw(this.hoveredUnit.health,     100, 445, ig.Font.ALIGN.LEFT, '000000');
                this.font.draw(this.hoveredUnit.health_max, 135, 445, ig.Font.ALIGN.LEFT, '000000');
            ...
            if(this.units[this.activeUnit].unitType === 'player' && this.clickedUnit === null && this.hoveredTerrain !== null) {
                ...
                this.font.draw(this.hoveredTerrain.type,  515, 426, ig.Font.ALIGN.LEFT, '000000');
                this.font.draw(this.hoveredTerrain.def,   570, 447, ig.Font.ALIGN.LEFT, '000000');
                this.font.draw(this.hoveredTerrain.avoid, 570, 459, ig.Font.ALIGN.LEFT, '000000');
            }

            if(this.mode === 'battle' && this.units[this.activeUnit] !== this.targetedUnit && this.targetedUnit.unitType === 'enemy') {
                //console.log(this.units[this.activeUnit].name + ' attacks ' + this.targetedUnit.name + '!');
                var a = this.units[this.activeUnit];
                var t = this.targetedUnit;
                //this.battleAnimScreen.draw(0, 0);
                if(this.getEntitiesByType(EntityBattle_anim_overlay).length === 0)
                    this.spawnEntity(EntityBattle_anim_overlay, ig.game.screen.x, ig.game.screen.y);

                // Target unit -------------------------------------------------
                if(this.getEntitiesByType(t.battleAnim).length === 0) {
                    var t_battleAnim = this.spawnEntity(t.battleAnim, 0, 0, {flip: true});
                    t_battleAnim.pos = {
                ...
                this.font.draw(t.name, 20, 30, ig.Font.ALIGN.LEFT);         // Unit name
                this.font.draw('100', 100, 340, ig.Font.ALIGN.RIGHT);       // Unit stat: HIT
                this.font.draw('100', 100, 365, ig.Font.ALIGN.RIGHT);       // Unit stat: DMG
                this.font.draw('100', 100, 390, ig.Font.ALIGN.RIGHT);       // Unit stat: CRT
                this.font.draw('[IMG]', 130, 385, ig.Font.ALIGN.LEFT);      // Weapon image
                this.font.draw('Iron Sword', 180, 385, ig.Font.ALIGN.LEFT); // Weapon name
                this.font.draw(t.health, 30, 440, ig.Font.ALIGN.LEFT);      // Unit health
                ...
                ig.system.context.beginPath();
                    ig.system.context.rect(
                        75,
                        441,
                        (t.health / t.health_max) * 200 * ig.system.scale - 2,
                        12 * ig.system.scale
                    );
                ig.system.context.closePath();
                ig.system.context.fill();
                ...
                // Active unit -------------------------------------------------
                if(this.getEntitiesByType(a.battleAnim).length === 0) {
                ...
                this.font.draw(a.name, ig.system.width - 20, 30, ig.Font.ALIGN.RIGHT);         // Unit name
                this.font.draw('100', ig.system.width - 5, 340, ig.Font.ALIGN.RIGHT);          // Unit stat: HIT
                this.font.draw('100', ig.system.width - 5, 365, ig.Font.ALIGN.RIGHT);          // Unit stat: DMG
                this.font.draw('100', ig.system.width - 5, 390, ig.Font.ALIGN.RIGHT);          // Unit stat: CRT
                this.font.draw('[IMG]', ig.system.width / 2 + 25, 385, ig.Font.ALIGN.LEFT);    // Weapon image
                this.font.draw('Iron Axe', ig.system.width / 2 + 80, 385, ig.Font.ALIGN.LEFT); // Weapon name
                this.font.draw(a.health, ig.system.width / 2 + 30, 440, ig.Font.ALIGN.LEFT);   // Unit health

                // Health border/background
                ig.system.context.fillStyle = 'rgb(0, 0, 0)';
                ig.system.context.beginPath();
                    ig.system.context.rect(
                        ig.system.width / 2 + 74,
                        440,
                        200 * ig.system.scale,
                        14 * ig.system.scale
                    );
                ...
                ig.system.context.beginPath();
                    ig.system.context.rect(
                        ig.system.width / 2 + 75,
                        441,
                        (a.health / a.health_max) * 200  * ig.system.scale - 2,
                        12 * ig.system.scale
                    );
                ig.system.context.closePath();
                ig.system.context.fill();
