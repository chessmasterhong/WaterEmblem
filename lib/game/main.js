    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        update: function() {
            ...
            if(this.battleAnimStage === 'attack' && this.units[this.activeUnit] !== this.targetedUnit && this.targetedUnit.unitType === 'enemy') {
                ...
                if(this.atkAnimTimer.delta() > 1 && this.attackQueue[0].currentAnim === this.attackQueue[0].anims.idle) {
                    // Initial attack
                    this.attackQueue[0].currentAnim = this.attackQueue[0].anims.attack;
                    ...
                    // Counterattack
                    this.attackQueue[1].currentAnim = this.attackQueue[1].anims.attack;
                    this.attackQueue[1].currentAnim.rewind();
                } else if(this.attackQueue[1].currentAnim.loopCount >= 1) {
                    // Second attack
                    if(this.attackQueue.length === 3 && this.attackQueue[2].currentAnim === this.attackQueue[2].anims.idle) {
                        this.attackQueue[2].currentAnim = this.attackQueue[2].anims.attack;
                    ...
                    // Clean up and end battle animation
                        ...
                        this.getEntityByName('battle_anim_overlay').kill();
                        this.attackQueue[0].kill();
                        this.attackQueue[1].kill();
                        if(this.attackQueue.length === 3)
                            this.attackQueue[2].kill();
        ...
        draw: function() {
            ...
            if((this.battleAnimStage === 'battle_prepare' || this.battleAnimStage === 'battle_start') &&
               this.units[this.activeUnit] !== this.targetedUnit && this.targetedUnit.unitType === 'enemy') {
