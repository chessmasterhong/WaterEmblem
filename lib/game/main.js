    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        update: function() {
            ...
            if(ig.input.pressed('SHIFT') && this.hoveredUnit !== null && this.units[this.activeUnit].unitType === 'player' && this.units[this.activeUnit].vel.x === 0 && this.units[this.activeUnit].vel.y === 0 && this.clickedUnit !== null) {
