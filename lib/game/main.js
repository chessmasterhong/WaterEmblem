...
.defines(function() {
    ...
    ig.BaseGame = ig.Game.extend({
        font20_default: new ig.Font('media/04b03_20.font.png', { fontColor: '#ECEEA1', borderColor: '#202020' }),
        font16_default: new ig.Font('media/04b03_16.font.png', { fontColor: '#ECEEA1', borderColor: '#202020' }),
        font12_default: new ig.Font('media/04b03_12.font.png', { fontColor: '#ECEEA1', borderColor: '#202020' }),
        font20_green:   new ig.Font('media/04b03_20.font.png', { fontColor: '#3CDC3C', borderColor: '#202020' }),
        font16_green:   new ig.Font('media/04b03_16.font.png', { fontColor: '#3CDC3C', borderColor: '#202020' }),
        font12_green:   new ig.Font('media/04b03_12.font.png', { fontColor: '#3CDC3C', borderColor: '#202020' }),
        font20_red:     new ig.Font('media/04b03_20.font.png', { fontColor: '#FF6400', borderColor: '#202020' }),
        font16_red:     new ig.Font('media/04b03_16.font.png', { fontColor: '#FF6400', borderColor: '#202020' }),
        font12_red:     new ig.Font('media/04b03_12.font.png', { fontColor: '#FF6400', borderColor: '#202020' }),
    ...
    */
    ...
    ig.BattleMode = ig.BaseGame.extend({
        ...
        update: function() {
            ...
            if(this.units[this.activeUnit] !== this.targetedUnit) {
                if(this.battleState === 'attack') {
                    ...
                    if(this.units[this.activeUnit].unitType === 'player' && this.targetedUnit.unitType === 'player') {
                        ...
                        for(var t = 0; t < this.assistTargets.length; t++) {
                            if(this.targetedUnit === this.assistTargets[t]) {
                                ...
                                //console.log('Healing with ' + this.units[this.activeUnit].item[0].name);
                                ...
                                // NOTE: NEED TO CLAMP HP VALUES OF TARGTED UNIT
                    ...
                    // Compute the bonuses/penalites of the weapon triangle
                    //var weaponBonuses = this.weaponTriangle(this.units[this.activeUnit], this.targetedUnit);
                    //console.log(this.weaponTriangle(this.units[this.activeUnit], this.targetedUnit));
                    ...
                    if(this.attackQueueIndex === 0 && this.atkAnimTimer.delta() > 1) {
                        ...
                        // Active unit is playing their attack animation and is on animation frame just before striking
                            ...
                            } else if(((this.computeBattleNormalHitChance(this.units[this.activeUnit], this.targetedUnit)) + this.weaponTriangle(this.units[this.activeUnit],
                                this.targetedUnit).a) > Math.random() * 100) {
                                console.log("Enemy evade rate is : " + this.targetedUnit.derived_stats.evade);
                                console.log("Player hit rate is: " + (this.computeBattleNormalHitChance(this.units[this.activeUnit], this.targetedUnit) + 
                                    this.weaponTriangle(this.units[this.activeUnit], this.targetedUnit).a));
                    ...
                    // Counterattack -----------------------------------------------
                        ...
                        // Target unit is playing their attack animation and is on animation frame just before striking
                            ...
                            } else if((this.computeBattleNormalHitChance(this.targetedUnit, this.units[this.activeUnit]) + 
                                this.weaponTriangle(this.targetedUnit, this.units[this.activeUnit])) > Math.random() * 100) {
                                console.log("Enemy evade rate is: " + this.targetedUnit.derived_stats.evade);
                                this.screenshakeIntensity = 5;
        ...
        // Compute Weapon Triangle Bonuses
        weaponTriangle: function(attacker, defender){
            ...
            if(attacker.item[0] != null && defender.item[0] != null){
                if(attacker.item[0].affinity === 'sword' && defender.item[0].affinity === 'axe'){
                    return {a: attacker.mod.hit + 15, b: defender.mod.hit - 15};
                }
                else if(attacker.item[0].affinity === 'sword' && defender.item[0].affinity === 'lance'){
                    return {a: attacker.mod.hit - 15, b: defender.mod.hit + 15};
                }
                else if(attacker.item[0].affinity === 'axe' && defender.item[0].affinity === 'lance'){
                    return {a: attacker.mod.hit + 15, b: defender.mod.hit - 15};
                }
                else if(attacker.item[0].affinity === 'axe' && defender.item[0].affinity === 'sword'){
                    return {a: attacker.mod.hit - 15, b: defender.mod.hit + 15};
                }
                else if(attacker.item[0].affinity === 'lance' && defender.item[0].affinity === 'sword'){
                    return {a: attacker.mod.hit + 15, b: defender.mod.hit - 15 };
                }
                else if(attacker.item[0].affinity === 'lance' && defender.item[0].affinity === 'axe'){
                    return {a: attacker.mod.hit - 15, b: defender.mod.hit + 15};
                }
                else
        ...
        draw: function() {
            ...
            if(this.units[this.activeUnit].selectedWeapon !== null && this.units[this.activeUnit].isEquipping) {
                ...
                if(atkChange > a.derived_stats.atk)
                    this.font16_green.draw(a.derived_stats.atk + '->' + atkChange, 455, 404);
                else if(atkChange < a.derived_stats.atk)
                    this.font16_red.draw(a.derived_stats.atk + '->' + atkChange, 455, 404);
                else
                    this.font16_default.draw(a.derived_stats.atk, 455, 404);

                if(hitChange > a.derived_stats.hit_rate)
                    this.font16_green.draw(a.derived_stats.hit_rate + '->' + hitChange, 455, 438);
                else if(hitChange < a.derived_stats.hit_rate)
                    this.font16_red.draw(a.derived_stats.hit_rate + '->' + hitChange, 455, 438);
                else
                    this.font16_default.draw(a.derived_stats.hit_rate, 455, 438);
                ...
                if(this.hoveredUnit !== null && this.attackTargets.length > 0) {
                    for(var i = 0; i < this.attackTargets.length; i++) {
                        if(this.hoveredUnit === this.attackTargets[i]) {
                            ...
                            if(this.units[this.activeUnit].item[0] !== null) this.units[this.activeUnit].item[0].icon.draw(            520,  10                      );
                            ...
                            this.font16_default.draw(this.computeBattleNormalHitChance(this.units[this.activeUnit], this.hoveredUnit), 600, 118                      );
                            ...
                            this.font16_default.draw(this.computeBattleNormalHitChance(this.hoveredUnit, this.units[this.activeUnit]), 549, 118, ig.Font.ALIGN.RIGHT );
                            ...
                            if(this.hoveredUnit.item[0] !== null) {
            ...
            if((this.battleState === 'battle_prepare' || this.battleState === 'battle_start') && this.units[this.activeUnit] !== this.targetedUnit) {
                ...
                if(this.battleState === 'battle_prepare') {
                    // Prepare battle animation overlay

                    // Layer 1: Battle animation background
                    if(this.battleAnimControllers.background === null)
                        this.battleAnimControllers.background = this.spawnEntity(EntityBattle_anim_background, ig.game.screen.x, ig.game.screen.y);

                    var activeUnit_terrain = this.getTerrain(this.units[this.activeUnit].pos.x, this.units[this.activeUnit].pos.y).type;
                    if(activeUnit_terrain === 'Plain')
                        this.battleAnimControllers.background.currentAnim = this.battleAnimControllers.background.anims.plains;
                    else if(activeUnit_terrain === 'Forest')
                        this.battleAnimControllers.background.currentAnim = this.battleAnimControllers.background.anims.forest;
                    else if(activeUnit_terrain === 'Mountain')
                        this.battleAnimControllers.background.currentAnim = this.battleAnimControllers.background.anims.mountain;
                    else
                        this.battleAnimControllers.background.currentAnim = this.battleAnimControllers.background.anims.plains;

                    // Layer 2: Battle animation terrain
                    if(this.battleAnimControllers.terrains === null)
                        this.battleAnimControllers.terrains = this.spawnEntity(EntityBattle_anim_terrains, ig.game.screen.x, ig.game.screen.y);
                    ...
                    if(this.battleAnimControllers.effects === null)
                        this.battleAnimControllers.effects = this.spawnEntity(EntityBattle_anim_effects, ig.game.screen.x, ig.game.screen.y);

                    // Layer 5: Battle animation data display
                    if(this.battleAnimControllers.gui === null)
                        this.battleAnimControllers.gui = this.spawnEntity(EntityBattle_anim_gui, ig.game.screen.x, ig.game.screen.y);
                    ...
                    this.battleAnimControllers.background.pos = {x: ig.game.screen.x, y: ig.game.screen.y};
                    this.battleAnimControllers.terrains.pos = {x: ig.game.screen.x, y: ig.game.screen.y};
                    this.battleAnimControllers.effects.pos = {x: ig.game.screen.x, y: ig.game.screen.y};
                    this.battleAnimControllers.gui.pos = {x: ig.game.screen.x, y: ig.game.screen.y};
                ...
                this.font20_default.draw(this.computeBattleNormalHitChance(a, t),      a_overlayDetailPos[1].x, a_overlayDetailPos[1].y, a_overlayDetailPos[1].align);
                ...
                this.font20_default.draw(a.item[0] !== null ? a.item[0].name : '----', a_overlayDetailPos[5].x, a_overlayDetailPos[5].y, a_overlayDetailPos[5].align);
                ...
                this.font20_default.draw(this.computeBattleNormalHitChance(t, a),      t_overlayDetailPos[1].x, t_overlayDetailPos[1].y, t_overlayDetailPos[1].align);
                ...
                this.font20_default.draw(t.item[0] !== null ? t.item[0].name : '----', t_overlayDetailPos[5].x, t_overlayDetailPos[5].y, t_overlayDetailPos[5].align);
