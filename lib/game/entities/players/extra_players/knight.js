...
.defines(function() {
    ...
    ig.global.EntityKnight = ig.global.EntityBase_player.extend({
        entityClassName: ['EntityKnight'],

        name: 'Wallace',

        animSheet: new ig.AnimationSheet('media/units/players/knight.png', 32, 32),
        statMugshot: new ig.Image('media/statMugshots/players/wallace.png'),
        mugshot: new ig.Image('media/mugshots/players/wallace.png'),
        modal: new ig.Image('media/modal/wallace_modal.png'),
        battleAnim: 'EntityKnight_battleanim',
