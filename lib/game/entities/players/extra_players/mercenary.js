...
.defines(function() {
    ...
    ig.global.EntityMercenary = ig.global.EntityBase_player.extend({
        entityClassName: ['EntityMercenary'],

        name: 'Raven',

        animSheet: new ig.AnimationSheet('media/units/players/mercenary.png', 32, 32),
        statMugshot: new ig.Image('media/statMugshots/players/raven.png'),
        mugshot: new ig.Image('media/mugshots/players/raven.png'),
        modal: new ig.Image('media/modal/raven_modal.png'),
        battleAnim: 'EntityMercenary_battleanim',
