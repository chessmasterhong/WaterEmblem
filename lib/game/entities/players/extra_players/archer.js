...
.defines(function() {
    ...
    ig.global.EntityArcher = ig.global.EntityBase_player.extend({
        entityClassName: ['EntityArcher'],

        name: 'Louisa',

        animSheet: new ig.AnimationSheet('media/units/players/archer.png', 32, 32),
        statMugshot: new ig.Image('media/statMugshots/players/louisa.png'),
        mugshot: new ig.Image('media/mugshots/players/louisa.png'),
        modal: new ig.Image('media/modal/louisa_modal.png'),
        battleAnim: 'EntityArcher_battleanim',
