...
.defines(function() {
    ...
    ig.global.EntityThief = ig.global.EntityBase_player.extend({
        entityClassName: ['EntityThief'],

        name: 'Matthew',

        animSheet: new ig.AnimationSheet('media/units/players/newThief.png', 32, 32),
        statMugshot: new ig.Image('media/statMugshots/players/matthew.png'),
        mugshot: new ig.Image('media/mugshots/players/matthew.png'),
        modal: new ig.Image('media/modal/matthew_modal.png'),
        battleAnim: 'EntityThief_battleanim',
