...
.defines(function() {
    ...
    ig.global.EntityCavalier = ig.global.EntityBase_player.extend({
        entityClassName: ['EntityCavalier'],

        name: 'Sain',

        animSheet: new ig.AnimationSheet('media/units/players/cavalier.png', 32, 32),
        statMugshot: new ig.Image('media/statMugshots/players/sain.png'),
        mugshot: new ig.Image('media/mugshots/players/sain.png'),
        modal: new ig.Image('media/modal/sain_modal.png'),
        battleAnim: 'EntityCavalier_battleanim',
