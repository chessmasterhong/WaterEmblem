...
.defines(function() {
    ...
    ig.global.EntitySniper = ig.global.EntityBase_player.extend({
        entityClassName: ['EntitySniper'],

        //name: 'Rebecca',

        animSheet: new ig.AnimationSheet('media/units/players/sniper.png', 32, 32),
        statMugshot: new ig.Image('media/statMugshots/players/rebecca.png'),
        mugshot: new ig.Image('media/mugshots/players/rebecca.png'),
        modal: new ig.Image('media/modal/rebecca_modal.png'),
        battleAnim: 'EntitySniper_battleanim',
        ...
        init: function(x, y, settings) {
            ...
            // Items
            this.item[0] = ig.game.itemCatalog.bow1;  this.item_uses[0] = this.item[0].uses;
