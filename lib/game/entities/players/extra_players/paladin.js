...
.defines(function() {
    ...
    ig.global.EntityPaladin= ig.global.EntityBase_player.extend({
        entityClassName: ['EntityPaladin'],

        //name: 'Rebecca',

        animSheet: new ig.AnimationSheet('media/units/players/paladin.png', 32, 32),
        statMugshot: new ig.Image('media/statMugshots/players/isodora.png'),
        mugshot: new ig.Image('media/mugshots/players/isodora.png'),
        modal: new ig.Image('media/modal/isodora_modal.png'),
        battleAnim: 'EntityPaladin_battleanim',
