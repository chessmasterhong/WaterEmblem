...
.defines(function() {
    ...
    ig.global.EntityWyvern_lord = ig.global.EntityBase_player.extend({
        ...
        init: function(x, y, settings) {
            ...
            // Items
            this.item[0] = ig.game.itemCatalog['lance' + ig.game.generateRandomInt(1, 10).toString()];  this.item_uses[0] = this.item[0].uses;
            ...
            this.item[2] = ig.game.itemCatalog['lance' + ig.game.generateRandomInt(1, 10).toString()];  this.item_uses[2] = this.item[2].uses;
            this.item[3] = ig.game.itemCatalog['lance' + ig.game.generateRandomInt(1, 10).toString()];  this.item_uses[3] = this.item[3].uses;
            this.item[4] = ig.game.itemCatalog['lance' + ig.game.generateRandomInt(1, 10).toString()];  this.item_uses[4] = this.item[4].uses;
