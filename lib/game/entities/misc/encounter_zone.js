        ...
        check: function(other) {
            ...
            if(other instanceof EntityPlayer) {
                ...
                if(other.pos.x % tilesize === 0 && other.vel.y % tilesize === 0) {
                    ...
                    if(lastTile_pos.x !== other.pos.x || lastTile_pos.y !== other.pos.y) {
                        // Compute encounter chance. If success, enter combat.
                        if(Math.random() <= this.chance) {
                            ig.global.playerWorldPos = {map: ig.game.director.currentLevel, x: other.pos.x, y: other.pos.y};
                            ig.system.setGame(BattleMode);
                        }
                    }

                    // Update last tile position
                    lastTile_pos.x = other.pos.x;
                    lastTile_pos.y = other.pos.y;
                }
            }
        },
