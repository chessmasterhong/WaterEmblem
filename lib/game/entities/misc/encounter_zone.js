                ...
                if(this.stop === 0) {
                    ...
                    if(this.last_tile_pos !== null && (this.last_tile_pos.x !== other.pos.x || this.last_tile_pos.y !== other.pos.y)) {
                        ...
                        if(Math.random() <= this.chance) {
                            ...
                            this.destination = ig.global.alignToGrid(other.pos.x, other.pos.y, ig.global.tilesize);
                            this.destination.x += ig.global.sgn(other.vel.x) * ig.global.tilesize;
                            this.destination.y += ig.global.sgn(other.vel.y) * ig.global.tilesize;
