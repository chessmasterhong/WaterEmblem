...
.defines(function() {
    ...
    ig.global.EntityBase_enemy = ig.Entity.extend({
        ...
        realignToGrid: function() {
            this.pos = ig.global.alignToGrid(this.pos.x, this.pos.y, this.tilesize);
            this.pos.x += ig.global.sgn(this.vel.x) * this.tilesize;
            this.pos.y += ig.global.sgn(this.vel.y) * this.tilesize;
            this.vel = {x: 0, y: 0};
        },
