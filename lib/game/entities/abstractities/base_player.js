...
.defines(function() {
    ...
    ig.global.EntityBase_player = ig.Entity.extend({
                    ...
                    if(this.idleTimer.delta() > 0.2) {
                        ...
                        // If unit used up all their movement points, end their turn
                            ...
                            if(typeof ig.game.getEntityByName('btn_wait') === 'undefined' && !ig.game.menuVisible) {
                                ...
                                // Begin menus ---------------------------------
                                if(ig.game.item_drop === null && !ig.game.units[ig.game.activeUnit].leveledUp) {
        ...
        draw: function() {
            ...
            if((typeof ig.game.units !== 'undefined' && ig.game.units[ig.game.activeUnit] === this && !this.turnUsed && this.idleTimer.delta() > 0.2) && ig.game.clickedUnit === this && ig.game.displayedPlayerPhaseModal === true) {
