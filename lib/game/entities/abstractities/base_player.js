                                                            ...
                                                            ig.game.spawnEntity(Button, ig.game.screen.x + 224, ig.game.screen.y + 32, {
                                                                ...
                                                                pressedDown: function() {
                                                                    ...
                                                                    if(ig.game.units[ig.game.activeUnit].selectedItemIndex === 0) {
                                                                        ...
                                                                        console.log("New atk after equipping the" +  ig.game.units[ig.game.activeUnit].selectedWeapon.name +  "is: " + newStats.atk);
                                                                        console.log("New atk after equipping the" +  ig.game.units[ig.game.activeUnit].selectedWeapon.name +  "is: " + newStats.wt);
                                                                        console.log("New atk after equipping the" +  ig.game.units[ig.game.activeUnit].selectedWeapon.name +  "is: " + newStats.hit);
                                                                        console.log("New atk after equipping the" +  ig.game.units[ig.game.activeUnit].selectedWeapon.name +  "is: " + newStats.crit);
