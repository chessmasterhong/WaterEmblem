                ...
                if(!this.turnUsed) {
                    ...
                    if(this.idleTimer.delta() > 0.2) {
                        ...
                        if(this.stat_move_curr < this.stat_move_max) {
                            ...
                            // Destination has been set
                                ...
                                //if(this.pos.x === this.destination.x && this.pos.y === this.destination.y) {
                                    ...
                                    var tile_pos = {
                                        x: Math.floor((this.pos.x + ig.global.tilesize / 2) / ig.global.tilesize),
                                        y: Math.floor((this.pos.y + ig.global.tilesize / 2) / ig.global.tilesize)
                                    }

                                    var tile_index = ig.game.backgroundMaps[1].data[tile_pos.y][tile_pos.x];
                                    this.stat_move_curr += ig.game.terrain[tile_index].move;

                                    // Keep these for debug purposes for adding new terrains
                                    //console.log("Tile Index: " + tile_index + " (x: " + tile_pos.x + ", y: " + tile_pos.y + ")");
                                    //console.log("Terrain Type: " + ig.game.terrain[tile_index].type);
                                    //console.log("Movement Cost: " + ig.game.terrain[tile_index].move);
                                    //console.log("Defense Bonus: " + ig.game.terrain[tile_index].def);
                                    //console.log("Avoid Bonus: " + ig.game.terrain[tile_index].avoid);
                                } //else {
                        ...
                        // If unit used up all their movement points, end their turn
                            ...
                            // Spawn menu
                            ig.game.spawnEntity(Button, ig.game.screen.x + 75, ig.game.screen.x + 65 , {
