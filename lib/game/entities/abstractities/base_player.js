...
.defines(function() {
    ...
    ig.global.EntityBase_player = ig.Entity.extend({
        ...
        stat: {
            ...
            con: 3, // Unit's base weight
            crit: 0, // Critical Hit Rate
            crit_rate: 0, // Unit's derived crit rate
            wt: 0, // Unit's base weight
            weight: 0, // Unit's derived weight
            hit: 0, // Unit's base hit rate
            hit_rate: 0// Unit's derived hit rate
        },
                                                                ...
                                                                pressedDown: function() {
                                                                    ...
                                                                    if(ig.game.units[ig.game.activeUnit].selectedItemIndex === 0) {
                                                                        ...
                                                                        var newStats = ig.game.applyWeapon(ig.game.units[ig.game.activeUnit].stat.str, 
                                                                            ig.game.units[ig.game.activeUnit].stat.weight, ig.game.units[ig.game.activeUnit].stat.hit_rate,
                                                                            ig.game.units[ig.game.activeUnit].stat.crit_rate);
                                                                            


                                                                        console.log("Atk stat after equipping the " + ig.game.units[ig.game.activeUnit].selectedWeapon.name + " is: " + ig.game.units[ig.game.activeUnit].stat.atk);
                                                                        console.log("Wt stat after equipping the " + ig.game.units[ig.game.activeUnit].selectedWeapon.name + " is: " + ig.game.units[ig.game.activeUnit].stat.wt);
                                                                        console.log("Hit stat after equipping the " + ig.game.units[ig.game.activeUnit].selectedWeapon.name + " is: " + ig.game.units[ig.game.activeUnit].stat.hit);
                                                                        console.log("Crit stat after equipping the " + ig.game.units[ig.game.activeUnit].selectedWeapon.name + " is: " + ig.game.units[ig.game.activeUnit].stat.crit);
