                        ...
                        // If unit used up all their movement points, end their turn
                            ...
                            if(typeof ig.game.getEntityByName('btn_wait') === 'undefined' && !ig.game.menuVisible) {
                                ...
                                if(ig.game.item_drop === null) {
                                    ...
                                    if(ig.game.units[ig.game.activeUnit] instanceof EntityHero && ig.game.getTerrain(this.pos.x, this.pos.y).type === 'Shop') {

                                        ig.game.spawnEntity(EntityButton_seize, ig.game.screen.x + 32, ig.game.screen.y + ++menuButtonIndex * 32); //Seize button
                                    }
                                }
                                // End menus -----------------------------------
                            }
