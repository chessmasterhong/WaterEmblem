                    ...
                    if(this.idleTimer.delta() > 0.2) {
                        ...
                        if(this.destination === null) {
                            ...
                            if(this.pointer.isClicking) {
                                ...
                                var d = Math.abs(this.pos.x - this.pointer.pos.x) + Math.abs(this.pos.y - this.pointer.pos.y);
                                ...
                                if(d <= Math.round(this.maxMovement)) {
                                    ...
                                    if(this.destination.x !== this.pos.x || this.destination.y !== this.pos.y) {
                                        var dest_entity = ig.game.spawnEntity(EntityTile_dummy, this.destination.x, this.destination.y);
                        ...
                        // Destination has been set
                            ...
                            if(this.pos.x === this.destination.x && this.pos.y === this.destination.y) {
                                ...
                                this.destination = null;
                                this.stat_move_curr = this.stat_move_max; //this.stat_move_curr++;
                            } else {
