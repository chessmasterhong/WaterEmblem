                                                                    ...
                                                                    if(typeof ig.game.getEntityByName('btn_equip') === 'undefined') {
                                                                        ...
                                                                        ig.game.spawnEntity(Button, ig.game.screen.x + 296, ig.game.screen.y + 32, {
                                                                            ...
                                                                            pressedUp: function() {
                                                                                ...
                                                                                var swap = ig.game.swapItems(ig.game.units[ig.game.activeUnit].item, ig.game.units[ig.game.activeUnit].item_uses, 0, ig.game.units[ig.game.activeUnit].selectedItemIndex);
                                                                                ig.game.units[ig.game.activeUnit].item = swap.inventory;
                                                                                ig.game.units[ig.game.activeUnit].item_uses = swap.item_uses;
