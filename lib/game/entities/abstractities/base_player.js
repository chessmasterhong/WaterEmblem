                                                ...
                                                ig.game.spawnEntity(Button, ig.game.screen.x + 128, ig.game.screen.y + (i + 1) * 32, {
                                                    ...
                                                    pressedDown: function() {
                                                        ...
                                                        if(typeof ig.game.getEntityByName('btn_equip') === 'undefined') {
                                                            ...
                                                            //ig.game.units[ig.game.activeUnit].selectedWeapon = ig.game.units[ig.game.activeUnit].item[i].name;
                                                            //console.log("Selected Item to Equip is: " + ig.game.units[ig.game.activeUnit].selectedWeapon);
                                                            ...
                                                            ig.game.spawnEntity(Button, ig.game.screen.x + 224, ig.game.screen.y + 32, {
                                                                ...
                                                                pressedDown: function() {
                                                                    ...
                                                                    if(ig.game.units[ig.game.activeUnit].selectedItemIndex === 0) {
                                                                        ...
                                                                        // player's stats.
                                                                        //console.log(ig.game.units[ig.game.activeUnit].selectedWeapon.atk);
                                                                        //console.log(ig.game.units[ig.game.activeUnit].selectedWeapon.wt);
                                                                        //console.log(ig.game.units[ig.game.activeUnit].selectedWeapon.hit);
                                                                        //console.log(ig.game.units[ig.game.activeUnit].selectedWeapon.crit);
                                                                        //console.log(ig.game.units[ig.game.activeUnit].mod);
                                                                        ...
                                                                        console.log("New mod atk is: " + buff.atk);
                                                                        var newStats = ig.game.applyWeapon(buff.atk, buff.wt, buff.hit, buff.crit);
                                                                        console.log("New wt: " + newStats.wt);
                                                                        console.log("New hit: " + newStats.hit);
                                                                        console.log("New crit: " + newStats.crit);
                                                                        console.log("New attack: " + newStats.atk);
                                                                        //console.log("New atk after equipping the" +  ig.game.units[ig.game.activeUnit].selectedWeapon +  "is: " + newStats.atk);
                                                                        //console.log("New atk after equipping the" +  ig.game.units[ig.game.activeUnit].selectedWeapon +  "is: " + newStats.wt);
                                                                        //console.log("New atk after equipping the" +  ig.game.units[ig.game.activeUnit].selectedWeapon +  "is: " + newStats.hit);
                                                                        //console.log("New atk after equipping the" +  ig.game.units[ig.game.activeUnit].selectedWeapon +  "is: " + newStats.crit);


                                                                        //console.log("Atk stat before equip: " + ig.game.units[ig.game.activeUnit].stat.atk);
                                                                        //ig.game.units[ig.game.activeUnit].stat.atk += ig.game.units[ig.game.activeUnit].mod.atk;
