                                                            ...
                                                            ig.game.spawnEntity(Button, ig.game.screen.x + 224, ig.game.screen.y + 32, {
                                                                ...
                                                                pressedDown: function() {
                                                                    ...
                                                                    if(ig.game.units[ig.game.activeUnit].selectedItemIndex === 0) {
                                                                        ...
                                                                        var newStats = ig.game.applyWeapon(ig.game.units[ig.game.activeUnit].stat.atk, 
                                                                        ...
                                                                        console.log("Atk stat after equipping the " + ig.game.units[ig.game.activeUnit].selectedWeapon.name + " is: " + ig.game.units[ig.game.activeUnit].mod.atk);
                                                                        console.log("Wt stat after equipping the " + ig.game.units[ig.game.activeUnit].selectedWeapon.name + " is: " + ig.game.units[ig.game.activeUnit].mod.wt);
                                                                        console.log("Hit stat after equipping the " + ig.game.units[ig.game.activeUnit].selectedWeapon.name + " is: " + ig.game.units[ig.game.activeUnit].mod.hit);
                                                                        console.log("Crit stat after equipping the " + ig.game.units[ig.game.activeUnit].selectedWeapon.name + " is: " + ig.game.units[ig.game.activeUnit].mod.crit);
