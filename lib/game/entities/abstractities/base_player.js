                                                        ...
                                                        if(typeof ig.game.getEntityByName('btn_equip') === 'undefined') {
                                                            ...
                                                            ig.game.spawnEntity(Button, ig.game.screen.x + 224, ig.game.screen.y + 32, {
                                                                ...
                                                                pressedDown: function() {
                                                                    ...
                                                                    if(ig.game.selectedItem == ig.game.units[ig.game.activeUnit].item[0]) {
                                                                        ...
                                                                        // Experimental swap
                                                                        ig.game.units[ig.game.activeUnit].item = ig.game.swapItems(ig.game.units[ig.game.activeUnit].item, 0, 1);
                                                                        console.log(ig.game.units[ig.game.activeUnit].item);
