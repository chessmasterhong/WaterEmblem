...
.defines(function() {
    ...
    ig.global.EntityBase_player = ig.Entity.extend({
        ...
        stat: {
            ...
            spd: 1,  // Speed
            luk: 1,  // Luck
            mov: 15,  // Movement points (radius in tiles)
        ...
        update: function() {
                        ...
                        // If unit used up all their movement points, end their turn
                            ...
                            if(typeof ig.game.getEntityByName('btn_wait') === 'undefined' && !ig.game.menuVisible) {
                                ...
                                for(var i = 0; i < assist_tile_search.length; i++) {
                                    ...
                                    if(typeof detected_player_unit !== 'undefined' && detected_player_unit.unitType === 'player' && detected_player_unit.health < detected_player_unit.health_max)
                                ...
                                var activeUnit_terrain = ig.game.getTerrain(ig.game.units[ig.game.activeUnit].pos.x, ig.game.units[ig.game.activeUnit].pos.y).type;
                                if(activeUnit_terrain === 'Armory'){
            ...
            // Not unit's turn; reset and hold variables to default value
                ...
                this.path = null;
                this.currentAnim = !this.turnUsed ? this.anims.idle : this.anims.wait;
            }
        }, // End update method
