                                                            ...
                                                            ig.game.spawnEntity(Button, ig.game.screen.x + 224, ig.game.screen.y + 32, {
                                                                ...
                                                                pressedDown: function() {
                                                                    ...
                                                                    if(ig.game.selectedItem == ig.game.units[ig.game.activeUnit].items[0]) {
                                                                        ...
                                                                        // Redraw the items
                                                                        ig.game.getEntityByName('btn_item_0').text = [ig.game.units[ig.game.activeUnit].items[0]];
                                                                        ig.game.getEntityByName('btn_item_1').text = [ig.game.units[ig.game.activeUnit].items[1]];
