...
.defines(function() {
    ...
    ig.global.EntityBase_player = ig.Entity.extend({
        ...
        leftClicked: function() {
            if(ig.game.battleState !== 'trading' && this._killed === false && ig.game.battleState !== 'shopping' && ig.game.battleState !== 'buying' && ig.game.battleState !== 'battle_transitionIn' && ig.game.battleState !== 'battle_prepare' && ig.game.battleState !== 'battle_transitionOut' && ig.game.battleState !== 'battle_start' && ig.game.battleState !== 'selling' && ig.game.battleState !== 'stats' && ig.game.battleState !== 'discarding' && ig.game.battleState !== 'objective') {
