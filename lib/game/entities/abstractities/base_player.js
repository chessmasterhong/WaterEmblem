                                                ...
                                                ig.game.spawnEntity(Button, ig.game.screen.x + 32, ig.game.screen.y + (i + 1) * 32, {
                                                    ...
                                                    pressedUp: function() {
                                                        ...
                                                        if(typeof ig.game.getEntityByName('btn_equip') !== 'undefined')
                                                            ig.game.getEntityByName('btn_equip').kill();
                                                        if(typeof ig.game.getEntityByName('btn_use') !== 'undefined')
                                                            ig.game.getEntityByName('btn_use').kill();
                                                        if(typeof ig.game.getEntityByName('btn_discard') !== 'undefined')
                                                            ig.game.getEntityByName('btn_discard').kill();
