...
.defines(function() {
    ...
    ig.global.EntityBase_player = ig.Entity.extend({
        ...
        levelUpStats: function() {
            if(this.levelUpStatPercentage.mag > this.randomN()) { this.stat.mag++; }
            if(this.levelUpStatPercentage.atk > this.randomN()) { this.stat.atk++; }
            if(this.levelUpStatPercentage.def > this.randomN()) { this.stat.def++; }
            if(this.levelUpStatPercentage.res > this.randomN()) { this.stat.res++; }
            if(this.levelUpStatPercentage.spd > this.randomN()) { this.stat.spd++; }
            if(this.levelUpStatPercentage.luk > this.randomN()) { this.stat.luk++; }
        },
