                                    ...
                                    pressedDown: function() {
                                        ...
                                        for(var i = 0; i < atk_tile_search.length; i++) {
                                            ...
                                            if(typeof detected_unit !== 'undefined')
                                                targets.push(detected_unit);
                                            ent.kill();
                                        }

                                        if(targets.length > 0)
                                            console.log(targets.length + ' target(s) available to attack. Select a target.')
                                        else
                                        ...
                                        // Check if clickedUnit has changed from the active unit, meaning a target has been selected
                                        //if(ig.game.clickedUnit !== ig.game.units[ig.game.activeUnit] && ig.game.clickedUnit.unitType === 'enemy') {
                                        //    console.log(ig.game.clickedUnit.name)
                                        //}
                                                            ...
                                                            ig.game.spawnEntity(Button, ig.game.screen.x + 224, ig.game.screen.y + 32, {
                                                                ...
                                                                pressedDown: function() {
                                                                    ...
                                                                    if(ig.game.units[ig.game.activeUnit].selectedItemIndex === 0) {
                                                                        ...
                                                                        ig.game.units[ig.game.activeUnit].stat.atk += ig.game.itemCatalog.Item1.atk;
                                                                        ...
                                                                        ig.game.units[ig.game.activeUnit].stat.atk += ig.game.itemCatalog.Item2.atk;
                                                                        console.log("Atk stat AFTER Equipping Bronze sword is: " + ig.game.units[ig.game.activeUnit].stat.atk);
