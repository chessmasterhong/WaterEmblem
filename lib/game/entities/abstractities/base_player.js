...
.defines(function() {
    ...
    ig.global.EntityBase_player = ig.Entity.extend({
        ...
        computeCriticalHitRate: function(weapon_critical, skill/2){
            return weapon_critical + skill/2;

        },

        // Function to compute the total critical hit rate between two
        // battling units.
        computeCriticalChance: function(player_critical, enemy_evade){
            return player_critical - enemy_evade;
