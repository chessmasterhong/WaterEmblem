...
.defines(function() {
    ...
    ig.global.EntityBase_enemy = ig.Entity.extend({
                        ...
                        if(this.pathTimer.delta() > 0.6) {
                            ...
                            if(this.destination === null) {
                                ...
                                if(this.immovable === false && target !== null) {
                                    try {
                                        this.getPath(target.pos.x, target.pos.y, false, ['EntityBase_player'], this.entitiesIgnore, this.entitiesAvoid);
                                    } catch (e) {
                                        this.path = null;
                                        this.turnUsed = true;
                                    }
                                    ...
                                    if(this.path !== null) {
                                        ...
                                        this.destination = ig.global.alignToGrid(this.pos.x + ig.global.tilesize / 2, this.pos.y + ig.global.tilesize / 2);
                                    }
                                } /*else {
                                    this.turnUsed = true;
                                }*/
        ...
        leftClicked: function() {
            if(ig.game.battleState !== 'trading' && (ig.game.units[ig.game.activeUnit].unitType !== 'player' || ig.game.battleState === 'attack' ) && this._killed === false && ig.game.battleState !== 'shopping' && ig.game.battleState !== 'buying' && ig.game.battleState !== 'battle_transitionIn' && ig.game.battleState !== 'battle_transitionOut' && ig.game.battleState !== 'battle_prepare' && ig.game.battleState !== 'battle_start' && ig.game.battleState !== 'discarding' && ig.game.battleState !== 'selling') {
