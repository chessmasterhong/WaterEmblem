...
.defines(function() {
    ...
    ig.global.EntityBase_enemy = ig.Entity.extend({
        ...
        dontMoveUntilTurn: 0,  // The turn in which this unit will start performing their action, otherwise it will skip its turn
        ...
        update: function() {
            ...
            if(ig.game.units[ig.game.activeUnit] === this && ig.game.battleState !== 'enemy_phase') {
                ...
                if(ig.game.turn_counter >= this.dontMoveUntilTurn) {
