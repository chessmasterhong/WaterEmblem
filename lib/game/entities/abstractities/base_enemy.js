...
.defines(function() {
    ...
    ig.global.EntityBase_enemy = ig.Entity.extend({
        ...
        leftClicked: function() {
            if(ig.game.battleState !== 'trading' && (ig.game.units[ig.game.activeUnit].unitType !== 'player' || ig.game.battleState === 'attack' ) && this._killed === false && ig.game.battleState !== 'shopping' && ig.game.battleState !== 'buying' && ig.game.battleState !== 'discarding' && ig.game.battleState !== 'selling') {
