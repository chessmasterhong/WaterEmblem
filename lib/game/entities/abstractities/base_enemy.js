...
.defines(function() {
    ...
    ig.global.EntityBase_enemy = ig.Entity.extend({
        ...
        update: function() {
            ...
            if(ig.game.units[ig.game.activeUnit] === this) {
                ...
                if(!this.turnUsed) {
                    ...
                    } else if(this.pathTimer.delta() > 0.5) {
        ...
        draw: function() {
            ...
            // Border/Background
            if(this.health < this.stat_maxHealth && this.hpBarTimer.delta() < 1) {
            ...
            if(ig.game.clickedUnit === this || (ig.game.units[ig.game.activeUnit] === this && this.pathTimer.delta() < 1)) {
                ...
                for(var i = 0; i < mid; i++) {
                    ctx.save();
                        ...
                        ctx.fillRect(
                            this.pos.x - (this.stat_move_max - i) * ig.global.tilesize - ig.game.screen.x,
                ...
                for(var i = 1; i < mid; i++) {
                    ctx.save();
                        ...
                        ctx.fillRect(
                            this.pos.x + (mid - i) * ig.global.tilesize - ig.game.screen.x,
