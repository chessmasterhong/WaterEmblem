...
.defines(function() {
    ...
    ig.global.EntityBattle_anim_background = ig.Entity.extend({
        ...
        animBackgroundFortress: new ig.AnimationSheet('media/battle_backgrounds/castle.png', 640, 480),
        ...
        animBackgroundCastle: new ig.AnimationSheet('media/battle_backgrounds/castle.png', 640, 480),
