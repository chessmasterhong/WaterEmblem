...
.defines(function() {
    ...
    ig.global.EntityCredits_roll = ig.Entity.extend({
        fontTitle:     new ig.Font('media/verdana_36b.font.png', { fontColor: '#E5E5E5' }),
        fontSection:   new ig.Font('media/verdana_20.font.png',  { fontColor: '#BBFFBB' }),
        fontContent16: new ig.Font('media/verdana_18.font.png',  { fontColor: '#E5E5E5' }),
        fontContent20: new ig.Font('media/verdana_20.font.png',  { fontColor: '#E5E5E5' }),
        ...
        draw: function() {
            ...
            this.fontContent16.draw('fan-made game created strictly for educational purposes', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER);
            this.fontContent16.draw('and to push the boundaries of ImpactJS. All animations,', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER);
            this.fontContent16.draw('map tiles, characters, and gameplay mechanics are',       this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER);
            this.fontContent16.draw('property of both Nintendo and Intelligent Systems.',      this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER);
