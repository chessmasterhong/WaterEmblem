...
.defines(function() {
    ...
    ig.global.EntityCredits_roll = ig.Entity.extend({
        ...
        draw: function() {
            ...
            this.font20.draw('_____', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER); // 1
            this.font20.draw('_____', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER); // 2

            y += this.s;
            this.font16.draw('Lead Programmer', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER);
            this.font20.draw('_____', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER); // 1
            this.font20.draw('_____', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER); // 1

            y += this.s;
            this.font16.draw('Programmer', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER);
            this.font20.draw('_____', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER); // 3
            this.font20.draw('_____', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER); // 4

            y += this.s;
            this.font16.draw('Artwork', this.x0, this.pos.y + this.dy * ++y, ig.Font.ALIGN.CENTER);
            this.font20.draw('_____', this.xL, this.pos.y + this.dy * ++y, ig.Font.ALIGN.RIGHT ); // 1
            this.font20.draw('_____', this.xR, this.pos.y + this.dy *   y, ig.Font.ALIGN.LEFT  );
            this.font20.draw('_____', this.xL, this.pos.y + this.dy * ++y, ig.Font.ALIGN.RIGHT ); // 2
            this.font20.draw('_____', this.xR, this.pos.y + this.dy *   y, ig.Font.ALIGN.LEFT  );
            ...
            this.font20.draw('_____', this.xL, this.pos.y + this.dy * ++y, ig.Font.ALIGN.RIGHT ); // 2
            this.font20.draw('_____', this.xR, this.pos.y + this.dy *   y, ig.Font.ALIGN.LEFT  );
            this.font20.draw('_____', this.xL, this.pos.y + this.dy * ++y, ig.Font.ALIGN.RIGHT ); // 3
            this.font20.draw('_____', this.xR, this.pos.y + this.dy *   y, ig.Font.ALIGN.LEFT  );
