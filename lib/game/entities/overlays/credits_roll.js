...
.defines(function() {
    ...
    ig.global.EntityCredits_roll = ig.Entity.extend({
        ...
        draw: function() {
            ...
            this.fontContent20.draw('"Augustine Army"',     this.xL, this.pos.y + this.dy * ++y, ig.Font.ALIGN.RIGHT ); // 4
            ...
            this.fontContent20.draw('Gamma V',              this.xR, this.pos.y + this.dy *   y, ig.Font.ALIGN.LEFT  );
            this.fontContent20.draw('"Light and Darkness"', this.xL, this.pos.y + this.dy * ++y, ig.Font.ALIGN.RIGHT ); // 4
            this.fontContent20.draw('Gamma V',              this.xR, this.pos.y + this.dy *   y, ig.Font.ALIGN.LEFT  );
            this.fontContent20.draw('"Land of Promise"',     this.xL, this.pos.y + this.dy * ++y, ig.Font.ALIGN.RIGHT ); // 4
