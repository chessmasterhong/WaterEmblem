...
ig.module(
    'game.entities.enemies.enemy_pirate'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_pirate = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_pirate'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newPirate.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_pirate.png'),
