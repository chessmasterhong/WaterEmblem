...
.defines(function() {
    ...
    ig.global.EntityEnemy_king = ig.global.EntityBase_enemy.extend({
        ...
        init: function(x, y, settings) {
            ...
            this.stat.str = ig.game.generateRandomInt(15, 30);
            this.stat.mag = ig.game.generateRandomInt(15, 30);
            this.stat.def = ig.game.generateRandomInt(15, 30);
            this.stat.skl = ig.game.generateRandomInt(15, 30);
            this.stat.res = ig.game.generateRandomInt(15, 30);
            this.stat.spd = ig.game.generateRandomInt(15, 30);
            this.stat.luk = ig.game.generateRandomInt(15, 30);
            this.stat.mov = 4;
