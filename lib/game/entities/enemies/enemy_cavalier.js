...
ig.module(
    'game.entities.enemies.enemy_cavalier'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_cavalier = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_cavalier'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_cavalier.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_cavalier.png'),
        battleAnim: 'EntityEnemy_cavalier_battleanim',
