/**
 *  enemy_advancedHero.js
 *  -----
 *
 */

ig.module(
    'game.entities.enemies.enemy_advancedHero'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemyAdvancedHero = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemyAdvancedHero'],

        name: 'filler',

        animSheet: new ig.AnimationSheet('media/units/players/hero.png', 32, 32),
        battleAnim: 'EntityEnemy_AdvancedHero_battleanim',
