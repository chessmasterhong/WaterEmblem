...
ig.module(
    'game.entities.enemies.enemy_valkyrie'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_valkyrie = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_valkyrie'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newValkyrie.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_valkyrie.png'),
