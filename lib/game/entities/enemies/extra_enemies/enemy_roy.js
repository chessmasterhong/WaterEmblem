...
ig.module(
    'game.entities.enemies.enemy_roy'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_roy = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_roy'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_roy.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_myrmidon.png'),
        battleAnim: 'EntityEnemy_lord_battleanim',
