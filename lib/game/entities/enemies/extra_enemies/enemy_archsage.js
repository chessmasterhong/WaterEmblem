...
ig.module(
    'game.entities.enemies.enemy_archsage'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_archsage = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_archsage'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newArchSage.png', 32, 32),
