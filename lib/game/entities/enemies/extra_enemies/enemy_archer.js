...
ig.module(
    'game.entities.enemies.enemy_archer'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_archer = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_archer'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_archer.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_archer.png'),
        battleAnim: 'EntityEnemy_Archer_battleanim',
