...
ig.module(
    'game.entities.enemies.enemy_hero'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_hero = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_hero'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_hero.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_hero.png'),
