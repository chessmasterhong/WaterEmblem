...
ig.module(
    'game.entities.enemies.enemy_troubadour'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_troubadour = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_troubadour'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_troubadour.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_troubadour.png'),
