...
.defines(function() {
    ...
    ig.global.EntityEnemy_nergal = ig.global.EntityBase_enemy.extend({
        ...
        init: function(x, y, settings) {
            // Stats
            this.level = 1;
            this.health_max = ig.game.generateRandomInt(45, 70);
            this.stat.str = ig.game.generateRandomInt(15, 25);
            this.stat.mag = ig.game.generateRandomInt(15, 25);
            this.stat.def = ig.game.generateRandomInt(15, 25);
            this.stat.skl = ig.game.generateRandomInt(15, 25);
            this.stat.res = ig.game.generateRandomInt(15, 25);
            this.stat.spd = ig.game.generateRandomInt(15, 25);
            this.stat.luk = ig.game.generateRandomInt(15, 25);
            this.stat.mov = 4;
