...
ig.module(
    'game.entities.enemies.enemy_sniper'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_sniper = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_sniper'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_sniper.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_sniper.png'),
        battleAnim: 'EntityEnemy_sniper_battleanim',
