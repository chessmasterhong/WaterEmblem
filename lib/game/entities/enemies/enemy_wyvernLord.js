...
ig.module(
    'game.entities.enemies.enemy_wyvernLord'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_wyvernLord = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_wyvernLord'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newWyvernLord.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_wyvern_lord.png'),
        battleAnim: 'EntityEnemy_WyvernLord_battleanim',
