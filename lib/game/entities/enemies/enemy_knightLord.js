...
.defines(function() {
    ...
    ig.global.EntityEnemy_knightLord = ig.global.EntityBase_enemy.extend({
        ...
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_paladin.png'),
        ...
        init: function(x, y, settings) {
            ...
            // Items
            this.item[0] = ig.game.itemCatalog['sword' + ig.game.generateRandomInt(1, 7).toString()];  this.item_uses[0] = this.item[0].uses;            //this.item[1] = null;  this.item_uses[1] = this.item[1].uses;
