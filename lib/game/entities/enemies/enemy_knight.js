...
ig.module(
    'game.entities.enemies.enemy_knight'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_knight = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_knight'],

        name: 'Knight',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_knight.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_knight.png'),
        battleAnim: 'EntityEnemy_Knight_battleanim',
