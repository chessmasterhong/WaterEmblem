/**
 *  enemy_swordmaster.js
 *  ---------------
 */

ig.module(
    'game.entities.enemies.enemy_swordmaster'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_swordmaster = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_swordmaster'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newSwordMaster.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_swordmaster.png'),
        battleAnim: 'EntityEnemy_swordmaster_battleanim',
        ...
        init: function(x, y, settings) {
            ...
            // Items
            this.item[0] = ig.game.itemCatalog['sword' + ig.game.generateRandomInt(1, 6).toString()];  this.item_uses[0] = this.item[0].uses;            //this.item[1] = null;  this.item_uses[1] = this.item[1].uses;
