...
ig.module(
    'game.entities.enemies.enemy_general'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_general = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_general'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_general.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_general.png'),
        battleAnim: 'EntityEnemy_general_battleanim',
