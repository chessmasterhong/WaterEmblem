/**
 *  enemy_wyvernKnight.js
 *  ---------------
 */

ig.module(
    'game.entities.enemies.enemy_wyvernKnight'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_wyvernKnight = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_wyvernKnight'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newWyvernKnight.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_wyvern_knight.png'),
