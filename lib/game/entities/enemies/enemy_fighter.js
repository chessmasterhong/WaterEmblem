...
ig.module(
    'game.entities.enemies.enemy_fighter'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_fighter = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_fighter'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_fighter.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_fighter.png'),
        battleAnim: 'EntityEnemy_fighter_battleanim',
        ...
        init: function(x, y, settings) {
            ...
            // Items
            this.item[0] = ig.game.itemCatalog['axe' + ig.game.generateRandomInt(1, 3).toString()];  this.item_uses[0] = this.item[0].uses;
