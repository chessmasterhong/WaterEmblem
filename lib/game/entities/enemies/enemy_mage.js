...
ig.module(
    'game.entities.enemies.enemy_mage'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_mage = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_mage'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newFemaleMage.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_mage.png'),
        battleAnim: 'EntityEnemy_mage_battleanim',
