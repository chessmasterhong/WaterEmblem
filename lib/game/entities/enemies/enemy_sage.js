...
ig.module(
    'game.entities.enemies.enemy_sage'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_sage = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_sage'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newFemaleSage.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_sage.png'),
        battleAnim: 'EntityEnemy_sage_battleanim',
        ...
        init: function(x, y, settings) {
            ...
            // Items
            this.item[0] = ig.game.itemCatalog['tome' + ig.game.generateRandomInt(1, 3).toString()];  this.item_uses[0] = this.item[0].uses;            //this.item[1] = null;  this.item_uses[1] = this.item[1].uses;
