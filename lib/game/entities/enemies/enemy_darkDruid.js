...
ig.module(
    'game.entities.enemies.enemy_darkDruid'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_darkDruid = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_darkDruid'],

        name: 'Practice Dummy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newDarkDruid.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_druid.png'),
