/**
 *  enemy_pegasusKnight.js
 *  ---------------
 */

ig.module(
    'game.entities.enemies.enemy_pegasusKnight'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_pegasusKnight = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_pegasusKnight'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newPegasusKnight.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_pegasus_knight.png'),
        battleAnim: 'EntityEnemy_pegasus_knight_battleanim',
        ...
        init: function(x, y, settings) {
            ...
            this.stat.skl = ig.game.generateRandomInt(1, 10);
            this.stat.luk = ig.game.generateRandomInt(1, 10);
            this.stat.mov = 4;

            this.validWeapon = ['lance'];
            // Items
            this.item[0] = ig.game.itemCatalog['lance' + ig.game.generateRandomInt(1, 4).toString()];  this.item_uses[0] = this.item[0].uses;            //this.item[1] = null;  this.item_uses[1] = this.item[1].uses;
