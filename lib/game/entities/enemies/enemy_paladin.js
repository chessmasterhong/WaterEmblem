...
ig.module(
    'game.entities.enemies.enemy_paladin'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_paladin= ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_paladin'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_paladin.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_paladin.png'),
        battleAnim: 'EntityEnemy_paladin_battleanim',
