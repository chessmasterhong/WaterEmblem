/**
 *  enemy_dracozombie.js
 *  ---------------
 */

ig.module(
    'game.entities.enemies.enemy_dracozombie'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_dracozombie = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_dracozombie'],

        name: 'Dracozombie',

        animSheet: new ig.AnimationSheet('media/units/enemies/dracozombie.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_paladin.png'),
        battleAnim: 'EntityDracozombie_battleanim',

        init: function(x, y, settings) {
            // Stats
            this.level = 1;
            this.health_max = ig.game.generateRandomInt(10, 40);
            this.stat.atk = ig.game.generateRandomInt(5, 10);
            ...
            this.validWeapon = ['misc'];

            // Items
            this.item[0] = ig.game.itemCatalog.misc1;  this.item_uses[0] = this.item[0].uses;
