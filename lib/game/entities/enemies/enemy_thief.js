...
ig.module(
    'game.entities.enemies.enemy_thief'
)
.requires(
...
.defines(function() {
    ...
    ig.global.EntityEnemy_thief = ig.global.EntityBase_enemy.extend({
        entityClassName: ['EntityEnemy_thief'],

        name: 'Enemy',

        animSheet: new ig.AnimationSheet('media/units/enemies/enemies_newThief.png', 32, 32),
        statMugshot: new ig.Image('media/mugshots/enemies/enemy_thief.png'),
        battleAnim: 'EntityEnemy_thief_battleanim',
