...
.defines(function() {
    ...
    ig.global.EntityEnemy_paladin_battleanim = ig.global.EntityBase_battleanim.extend({
        animSheet: new ig.AnimationSheet('media/units/animations/enemy_paladin.png', 302.5, 250),
