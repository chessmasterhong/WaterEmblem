...
.defines(function() {
    ...
    ig.global.EntityKnight_battleanim = ig.global.EntityBase_battleanim.extend({
        ...
        init: function(x, y, settings) {
            ...
            this.anims.attack0 = new ig.Animation(this.animSheet, 0.10, [0, 1, 2, 3, 4, 5, 6, 7, 8, 8, 8, 8], true);
            this.anims.attack1 = new ig.Animation(this.animSheet, 0.10, [9, 10, 11, 12, 13, 14, 15, 16], true);
