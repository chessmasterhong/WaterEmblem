...
.defines(function() {
    ...
    ig.global.EntityEnemy_Knight_battleanim = ig.global.EntityBase_battleanim.extend({
        animSheet: new ig.AnimationSheet('media/units/animations/enemy_knight.png', 307.5, 102.5),
        animSheetCrit: new ig.AnimationSheet('media/units/animations/enemy_knight_critical.png', 312.5, 195),

        attackSize:   {x: 307.5, y: 102.5},
        attackOffset: {x: 35, y: -9},
