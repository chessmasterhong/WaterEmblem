...
.defines(function() {
   ig.global.ItemCatalog = ig.Class.extend({
        ...
        */
        ...
        // Items
        item1: { name: 'Vulenary', type: 'consumable', affinity: 'potion', range: 1, icon: new ig.Image('media/weapons/items/vulenary.png'), atk: 0, wt: 0, crit: 0, hit: 0, uses: 3, heal: -5, cost: 100},
        item1: {name: 'Elixer', type: 'consumable', affinity: 'potion', range: 1, icon: new ig.Image('media/weapons/items/elixer.png'), atk: 0, wt: 0, crit: 0, hit: 0, uses: 3, heal: 10, cost: 1300},
   });
});
