...
.defines(function() {
   ig.global.ItemCatalog = ig.Class.extend({
        ...
        */
        ...
        // Staffs
        staff1: { name: 'Heal Staff', type: 'equip', affinity: 'staff', range: 1, icon: new ig.Image('media/weapons/staffs/healStaff.png'), atk: 0, wt: 3, crit: 0, hit: 0, uses: 45, heal: 5, cost: 200, desc: '' },

        // Healing items
        item1: { name: 'Vulenary', type: 'consumable', affinity: 'potion', range: 1, icon: new ig.Image('media/weapons/items/vulenary.png'), uses: 3, cost:  100, desc: '', effect: function(entity){ entity.receiveDamage(-5, this) } },
        item2: { name: 'Elixer',   type: 'consumable', affinity: 'potion', range: 1, icon: new ig.Image('media/weapons/items/elixer.png'),   uses: 3, cost: 1300, desc: '', effect: function(entity){ entity.receiveDamage(-10, this) } },
   });
});
