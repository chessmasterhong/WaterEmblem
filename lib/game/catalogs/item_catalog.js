...
.defines(function() {
    ...
    ig.global.ItemCatalog = ig.Class.extend({
        ...
        */
        ...
        // Staffs
        staff1: { name: 'Heal Staff', type: 'equip', affinity: 'staff', range: 1, icon: new ig.Image('media/weapons/staffs/healStaff.png'), atk: 0, wt: 3, crit: 0, hit: 0, uses: 45, heal: 5, cost: 200, desc: '' , bonus: 17},
