...
.defines(function() {
   ig.global.ItemCatalog = ig.Class.extend({
        ...
        */
        ...
        // Items
        item3: { name: 'Energy Drop', type: 'consumable', affinity: 'item', range: 1, icon: new ig.Image('media/weapons/items/energy_drop.png'), uses: 1, effect: function(entity){entity.stat.str += 2 }},
        item4: { name: 'Angelic Robe', type: 'consumable', affinity: 'item', range: 1, icon: new ig.Image('media/weapons/items/angelic_robe.png'), uses: 1, effect: function(entity){entity.health_max += 7}},
