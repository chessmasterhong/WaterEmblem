...
.defines(function() {
   ig.global.ItemCatalog = ig.Class.extend({
        ...
        */
        ...
        // Bows
        bow1:   { name: 'Iron Bow', type: 'equip', affinity: 'bow', iron_bow: new ig.Image('media/weapons/bows/iron_bow.png'), atk: 6, wt: 5, crit: 0, hit: 85, uses: 45, cost: 540},
        bow2:   { name: 'Steel Bow', type: 'equip', affinity: 'bow', steel_bow: new ig.Image('media/weapons/bows/steel_bow.png'), atk: 9, wt: 9, crit: 0, hit: 70, uses: 30, cost: 720},
        bow3:   { name: 'Silver Bow', type: 'equip', affinity: 'bow', silver_bow: new ig.Image('media/weapons/bows/silver_bow.png'), atk: 13, wt: 6, crit: 0, hit: 75, uses: 20, cost: 1600},
        bow4:   { name: 'Killer Bow', type: 'equip', affinity: 'bow', killer_bow: new ig.Image('media/weapons/bows/killer_bow.png'), atk: 9, wt: 7, crit: 30, hit: 75, uses: 20, cost: 1400},
        bow5:   { name: 'Short Bow', type: 'equip', affinity: 'bow', short_bow: new ig.Image('media/weapons/bows/short_bow.png'), atk: 5, wt: 3, crit: 10, hit: 85, uses: 22, cost: 1760},
   });
});
