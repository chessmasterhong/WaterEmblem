    ...
    draw: function() {
        ...
        if (ig.Entity._debugShowPaths && this.path) {
            ...
            ctx.save();
                ...
                ctx.strokeStyle = 'rgba(0, 240, 240, 0.6)';
                ctx.lineWidth = ig.system.scale * 4;
                ...
                ctx.fillRect(
                    this.path[this.path.length - 1].x - ig.game.screen.x,
                    this.path[this.path.length - 1].y - ig.game.screen.y,
                    mapTilesize,
                    mapTilesize
                );
