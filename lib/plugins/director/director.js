/***********************************************************************
  ...
  A Director plugin which is really simply a way to manage and move
  between levels. It stores an array of levels and allows one to for
  example advance to the next level, go back one level, go to the last
  level, append new levels etc.
***********************************************************************/
