...
wm.config = {
	...
	project: {
		...
		'entityFiles': ['lib/game/entities/generators/*.js', 'lib/game/entities/*.js',
						'lib/game/entities/enemies/*.js', 'lib/game/entities/powerups/*.js',
						'lib/game/entities/miscellaneous/*.js'],
